...
public final class AppComponent implements JsonSerializable<AppComponent> {
    ...
    static {
        JsonMergePatchHelper.setAppComponentAccessor(new JsonMergePatchHelper.AppComponentAccessor() {
            @Override
            public AppComponent prepareModelForJsonMergePatch(AppComponent model, boolean jsonMergePatchEnabled) {
                model.serializeAsJsonMergePatch(jsonMergePatchEnabled);
                return model;
            }

            @Override
            public boolean isJsonMergePatch(AppComponent model) {

...
public final class DiskAccessesListPrivateEndpointConnectionsMockTests {
    ...
    public void testListPrivateEndpointConnections() throws Exception {
        String responseStr
            = "{\"value\":[{\"properties\":{\"privateEndpoint\":{\"id\":\"beldawkzbaliourq\"},\"privateLinkServiceConnectionState\":{\"status\":\"Pending\",\"description\":\"uhashsfwx\",\"actionsRequired\":\"owzxcu\"},\"provisioningState\":\"Failed\"},\"id\":\"ooxdjebwpuc\",\"name\":\"wfvovbv\",\"type\":\"euecivyhzceuoj\"}]}";
        ...
        PagedIterable<PrivateEndpointConnection> response
            = manager.diskAccesses().listPrivateEndpointConnections("vgomz", "fmisg", com.azure.core.util.Context.NONE);

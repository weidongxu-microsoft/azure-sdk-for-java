...
public final class PrivateLinkResourcePropertiesTests {
    ...
    public void testDeserialize() throws Exception {
        PrivateLinkResourceProperties model = BinaryData.fromString(
            "{\"groupId\":\"zoqftiyqzrnkcqvy\",\"requiredMembers\":[\"hzls\",\"cohoq\",\"nwvlryavwhheunmm\"],\"requiredZoneNames\":[\"yxzk\",\"noc\"]}")
            .toObject(PrivateLinkResourceProperties.class);
        Assertions.assertEquals("yxzk", model.requiredZoneNames().get(0));
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        PrivateLinkResourceProperties model
            = new PrivateLinkResourceProperties().withRequiredZoneNames(Arrays.asList("yxzk", "noc"));

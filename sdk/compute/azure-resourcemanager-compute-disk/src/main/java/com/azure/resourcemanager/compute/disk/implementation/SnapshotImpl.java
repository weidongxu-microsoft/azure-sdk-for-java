...
import com.azure.resourcemanager.compute.disk.models.CopyCompletionError;
...
import com.azure.resourcemanager.compute.disk.models.SnapshotAccessState;
...
public final class SnapshotImpl implements Snapshot, Snapshot.Definition, Snapshot.Update {
    ...
    SnapshotImpl(String name, com.azure.resourcemanager.compute.disk.ComputeDiskManager serviceManager) {
    ...
    SnapshotImpl(SnapshotInner innerObject, com.azure.resourcemanager.compute.disk.ComputeDiskManager serviceManager) {
    ...
    public SnapshotImpl withCompletionPercent(Double completionPercent) {

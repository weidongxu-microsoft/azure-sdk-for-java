...
public final class DiskAccessesClientImpl implements DiskAccessesClient {
     ...
     */
    DiskAccessesClientImpl(AzureComputeResourceManagementApiImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AzureComputeResourceManagementApiDiskAccesses to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "AzureComputeResourceManagementApiDiskAccesses")
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String diskAccessName,
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, diskAccessName, diskAccess, accept, Context.NONE);
    }

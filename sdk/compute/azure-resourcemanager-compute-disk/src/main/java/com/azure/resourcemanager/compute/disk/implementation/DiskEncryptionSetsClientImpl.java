...
import com.azure.resourcemanager.compute.disk.models.DiskEncryptionSetList;
...
public final class DiskEncryptionSetsClientImpl implements DiskEncryptionSetsClient {
     ...
     */
    DiskEncryptionSetsClientImpl(AzureComputeResourceManagementApiImpl client) {
    ...
    /**
     * The interface defining all the services for AzureComputeResourceManagementApiDiskEncryptionSets to be used by the
     * proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "AzureComputeResourceManagementApiDiskEncryptionSets")

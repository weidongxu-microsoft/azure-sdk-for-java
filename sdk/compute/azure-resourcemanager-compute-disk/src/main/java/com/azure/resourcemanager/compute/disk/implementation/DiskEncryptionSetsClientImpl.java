...
import com.azure.resourcemanager.compute.disk.fluent.models.DiskEncryptionSetInner;
import com.azure.resourcemanager.compute.disk.implementation.models.DiskEncryptionSetList;
...
import com.azure.resourcemanager.compute.disk.models.DiskEncryptionSetUpdate;
...
public final class DiskEncryptionSetsClientImpl implements DiskEncryptionSetsClient {
     ...
     */
    DiskEncryptionSetsClientImpl(ComputeDiskManagementClientImpl client) {
    ...
    /**
     * The interface defining all the services for ComputeDiskManagementClientDiskEncryptionSets to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "ComputeDiskManagementClientDiskEncryptionSets")
    public interface DiskEncryptionSetsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<DiskEncryptionSetInner> getByResourceGroupSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("diskEncryptionSetName") String diskEncryptionSetName, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<DiskEncryptionSetList> listByResourceGroupSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<DiskEncryptionSetList> listSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<ResourceUriList> listAssociatedResourcesSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("diskEncryptionSetName") String diskEncryptionSetName, @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String diskEncryptionSetName,
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, diskEncryptionSetName, contentType, accept,
            diskEncryptionSet, Context.NONE);
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String diskEncryptionSetName) {
        ...
        return service.deleteSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, diskEncryptionSetName, Context.NONE);
    }
    ...
    private PagedResponse<DiskEncryptionSetInner> listSinglePage() {
        ...
        final String accept = "application/json";
        Response<DiskEncryptionSetList> res = service.listSync(this.client.getEndpoint(), this.client.getApiVersion(),
    ...
    private Mono<PagedResponse<String>> listAssociatedResourcesSinglePageAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(
                context -> service.listAssociatedResources(this.client.getEndpoint(), this.client.getApiVersion(),
                    this.client.getSubscriptionId(), resourceGroupName, diskEncryptionSetName, accept, context))
    ...
    private PagedResponse<String> listAssociatedResourcesSinglePage(String resourceGroupName,
        ...
        Response<ResourceUriList> res
            = service.listAssociatedResourcesSync(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, diskEncryptionSetName, accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }

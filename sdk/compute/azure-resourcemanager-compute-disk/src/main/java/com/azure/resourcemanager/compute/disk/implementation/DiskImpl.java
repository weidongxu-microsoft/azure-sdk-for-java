...
import com.azure.resourcemanager.compute.disk.models.DiskState;
...
import com.azure.resourcemanager.compute.disk.models.EncryptionSettingsCollection;
...
public final class DiskImpl implements Disk, Disk.Definition, Disk.Update {
    ...
    public AvailabilityPolicy availabilityPolicy() {
        return this.innerModel().availabilityPolicy();
    }
    ...
    DiskImpl(String name, com.azure.resourcemanager.compute.disk.ComputeDiskManager serviceManager) {
    ...
    DiskImpl(DiskInner innerObject, com.azure.resourcemanager.compute.disk.ComputeDiskManager serviceManager) {
    ...
    public DiskImpl withCompletionPercent(Double completionPercent) {
    ...
    public DiskImpl withAvailabilityPolicy(AvailabilityPolicy availabilityPolicy) {
        if (isInCreateMode()) {
            this.innerModel().withAvailabilityPolicy(availabilityPolicy);
            return this;
        } else {
            this.updateDisk.withAvailabilityPolicy(availabilityPolicy);
            return this;
        }
    }

...
import com.azure.resourcemanager.compute.disk.models.DiskList;
...
public final class DisksClientImpl implements DisksClient {
     ...
     */
    DisksClientImpl(AzureComputeResourceManagementApiImpl client) {
        this.service = RestProxy.create(DisksService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for AzureComputeResourceManagementApiDisks to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "AzureComputeResourceManagementApiDisks")
    public interface DisksService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<DiskList> listSync(@HostParam("$host") String endpoint, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @HeaderParam("Accept") String accept, Context context);
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String diskName, DiskInner disk) {
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, diskName, disk, accept, Context.NONE);
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String diskName) {
        ...
        return service.deleteSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, diskName, accept, Context.NONE);
    }
    ...
    private Response<BinaryData> grantAccessWithResponse(String resourceGroupName, String diskName,
        ...
        return service.grantAccessSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, diskName, grantAccessData, accept, Context.NONE);
    }

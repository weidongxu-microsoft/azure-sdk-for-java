...
import com.azure.resourcemanager.compute.disk.fluent.models.DiskInner;
import com.azure.resourcemanager.compute.disk.implementation.models.DiskList;
import com.azure.resourcemanager.compute.disk.models.ApiErrorException;
import com.azure.resourcemanager.compute.disk.models.DiskUpdate;
...
public final class DisksClientImpl implements DisksClient {
     ...
     */
    DisksClientImpl(ComputeDiskManagementClientImpl client) {
        this.service = RestProxy.create(DisksService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for ComputeDiskManagementClientDisks to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "ComputeDiskManagementClientDisks")
    public interface DisksService {
        ...
        Mono<Response<Flux<ByteBuffer>>> update(@HostParam("endpoint") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("diskName") String diskName,
            @HeaderParam("Content-Type") String contentType, @HeaderParam("Accept") String accept,
            @BodyParam("application/json") DiskUpdate disk, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<DiskList>> listByResourceGroup(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<DiskList> listByResourceGroupSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName, String diskName,
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, diskName, contentType, accept, disk, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String diskName, DiskInner disk) {
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, diskName, contentType, accept, disk, Context.NONE);
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String diskName) {
        ...
        return service.deleteSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, diskName, Context.NONE);
    }
    ...
    private PagedResponse<DiskInner> listByResourceGroupSinglePage(String resourceGroupName) {
        ...
        final String accept = "application/json";
        Response<DiskList> res = service.listByResourceGroupSync(this.client.getEndpoint(), this.client.getApiVersion(),
    ...
    private PagedResponse<DiskInner> listSinglePage() {
        ...
        final String accept = "application/json";
        Response<DiskList> res = service.listSync(this.client.getEndpoint(), this.client.getApiVersion(),
    ...
    private Mono<Response<Flux<ByteBuffer>>> grantAccessWithResponseAsync(String resourceGroupName, String diskName,
        ...
        return FluxUtil
            .withContext(context -> service.grantAccess(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, diskName, contentType, accept, grantAccessData,
                context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }

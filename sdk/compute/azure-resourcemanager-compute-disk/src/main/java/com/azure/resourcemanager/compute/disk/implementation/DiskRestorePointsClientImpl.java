...
import com.azure.resourcemanager.compute.disk.implementation.models.DiskRestorePointList;
...
public final class DiskRestorePointsClientImpl implements DiskRestorePointsClient {
     ...
     */
    DiskRestorePointsClientImpl(ComputeDiskManagementClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for ComputeDiskManagementClientDiskRestorePoints to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "ComputeDiskManagementClientDiskRestorePoints")
    public interface DiskRestorePointsService {
        ...
        Mono<Response<DiskRestorePointInner>> get(@HostParam("endpoint") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<DiskRestorePointInner> getSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("restorePointCollectionName") String restorePointCollectionName,
            @PathParam("vmRestorePointName") String vmRestorePointName,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<DiskRestorePointList>> listByRestorePoint(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("restorePointCollectionName") String restorePointCollectionName,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<DiskRestorePointList> listByRestorePointSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("restorePointCollectionName") String restorePointCollectionName,
            @PathParam("vmRestorePointName") String vmRestorePointName, @HeaderParam("Accept") String accept,
        ...
        Mono<Response<Flux<ByteBuffer>>> revokeAccess(@HostParam("endpoint") String endpoint,
            ...
            @PathParam("restorePointCollectionName") String restorePointCollectionName,
            @PathParam("vmRestorePointName") String vmRestorePointName,
            @PathParam("diskRestorePointName") String diskRestorePointName, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<DiskRestorePointList> listByRestorePointNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("endpoint") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    public Response<DiskRestorePointInner> getWithResponse(String resourceGroupName, String restorePointCollectionName,
        ...
        if (vmRestorePointName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter vmRestorePointName is required and cannot be null."));
        }
        if (diskRestorePointName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter diskRestorePointName is required and cannot be null."));
        }
        final String accept = "application/json";
    ...
    private Mono<PagedResponse<DiskRestorePointInner>> listByRestorePointSinglePageAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listByRestorePoint(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, restorePointCollectionName, vmRestorePointName,
                accept, context))
     ...
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the List Disk Restore Points operation response along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<DiskRestorePointInner> listByRestorePointSinglePage(String resourceGroupName,
        String restorePointCollectionName, String vmRestorePointName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String accept = "application/json";
        Response<DiskRestorePointList> res = service.listByRestorePointSync(this.client.getEndpoint(),
            this.client.getApiVersion(), this.client.getSubscriptionId(), resourceGroupName, restorePointCollectionName,
            vmRestorePointName, accept, Context.NONE);
    ...
    private PagedResponse<DiskRestorePointInner> listByRestorePointSinglePage(String resourceGroupName,
        ...
        Response<DiskRestorePointList> res = service.listByRestorePointSync(this.client.getEndpoint(),
            this.client.getApiVersion(), this.client.getSubscriptionId(), resourceGroupName, restorePointCollectionName,
            vmRestorePointName, accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    public PagedIterable<DiskRestorePointInner> listByRestorePoint(String resourceGroupName,
        ...
        return new PagedIterable<>(
            () -> listByRestorePointSinglePage(resourceGroupName, restorePointCollectionName, vmRestorePointName),
            nextLink -> listByRestorePointNextSinglePage(nextLink));
    }
    ...
    public PagedIterable<DiskRestorePointInner> listByRestorePoint(String resourceGroupName,
        String restorePointCollectionName, String vmRestorePointName, Context context) {
        return new PagedIterable<>(() -> listByRestorePointSinglePage(resourceGroupName, restorePointCollectionName,
            vmRestorePointName, context), nextLink -> listByRestorePointNextSinglePage(nextLink, context));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> grantAccessWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.grantAccess(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, restorePointCollectionName, vmRestorePointName,
                diskRestorePointName, contentType, accept, grantAccessData, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> grantAccessWithResponse(String resourceGroupName, String restorePointCollectionName,
        ...
        return service.grantAccessSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, restorePointCollectionName, vmRestorePointName,
            diskRestorePointName, contentType, accept, grantAccessData, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<AccessUriInner>, AccessUriInner> beginGrantAccess(String resourceGroupName,
        String restorePointCollectionName, String vmRestorePointName, String diskRestorePointName,
        GrantAccessData grantAccessData) {
        Response<BinaryData> response = grantAccessWithResponse(resourceGroupName, restorePointCollectionName,
    ...
    public AccessUriInner grantAccess(String resourceGroupName, String restorePointCollectionName,
        String vmRestorePointName, String diskRestorePointName, GrantAccessData grantAccessData) {
        return beginGrantAccess(resourceGroupName, restorePointCollectionName, vmRestorePointName, diskRestorePointName,
            grantAccessData).getFinalResult();
    }
    ...
    public AccessUriInner grantAccess(String resourceGroupName, String restorePointCollectionName,
        String vmRestorePointName, String diskRestorePointName, GrantAccessData grantAccessData, Context context) {
        return beginGrantAccess(resourceGroupName, restorePointCollectionName, vmRestorePointName, diskRestorePointName,
            grantAccessData, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> revokeAccessWithResponse(String resourceGroupName, String restorePointCollectionName,
        String vmRestorePointName, String diskRestorePointName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        return service.revokeAccessSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, restorePointCollectionName, vmRestorePointName,
            diskRestorePointName, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginRevokeAccess(String resourceGroupName,
        String restorePointCollectionName, String vmRestorePointName, String diskRestorePointName) {
        Response<BinaryData> response = revokeAccessWithResponse(resourceGroupName, restorePointCollectionName,
    ...
    public SyncPoller<PollResult<Void>, Void> beginRevokeAccess(String resourceGroupName,
        ...
        Response<BinaryData> response = revokeAccessWithResponse(resourceGroupName, restorePointCollectionName,
            vmRestorePointName, diskRestorePointName, context);
    ...
    public void revokeAccess(String resourceGroupName, String restorePointCollectionName, String vmRestorePointName,
        ...
        beginRevokeAccess(resourceGroupName, restorePointCollectionName, vmRestorePointName, diskRestorePointName)
            .getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<DiskRestorePointInner> listByRestorePointNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<DiskRestorePointList> res
            = service.listByRestorePointNextSync(nextLink, this.client.getEndpoint(), accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<DiskRestorePointInner> listByRestorePointNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<DiskRestorePointList> res
            = service.listByRestorePointNextSync(nextLink, this.client.getEndpoint(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }

    private static final ClientLogger LOGGER = new ClientLogger(DiskRestorePointsClientImpl.class);
}

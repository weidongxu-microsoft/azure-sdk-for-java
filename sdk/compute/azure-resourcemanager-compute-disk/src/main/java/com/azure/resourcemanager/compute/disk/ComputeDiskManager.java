...
package com.azure.resourcemanager.compute.disk;
...
import com.azure.resourcemanager.compute.disk.implementation.AzureComputeResourceManagementApiBuilder;
import com.azure.resourcemanager.compute.disk.implementation.DiskAccessesImpl;
...
/**
 * Entry point to ComputeDiskManager.
 * Compute Client.
 */
public final class ComputeDiskManager {
    ...
    private ComputeDiskManager(HttpPipeline httpPipeline, AzureProfile profile, Duration defaultPollInterval) {
    ...
    /**
     * Creates an instance of ComputeDisk service API entry point.
     * 
     * @param credential the credential to use.
     * @param profile the Azure profile for client.
     * @return the ComputeDisk service API instance.
     */
    public static ComputeDiskManager authenticate(TokenCredential credential, AzureProfile profile) {
     ...
     * @return the ComputeDisk service API instance.
     */
    public static ComputeDiskManager authenticate(HttpPipeline httpPipeline, AzureProfile profile) {
        Objects.requireNonNull(httpPipeline, "'httpPipeline' cannot be null.");
        Objects.requireNonNull(profile, "'profile' cannot be null.");
        return new ComputeDiskManager(httpPipeline, profile, null);
    }

    /**
     * Gets a Configurable instance that can be used to create ComputeDiskManager with optional configuration.
     * 
     * @return the Configurable instance allowing configurations.
     */
    public static Configurable configure() {
        return new ComputeDiskManager.Configurable();
    }
    ...
    public static final class Configurable {
        ...
        private static final Map<String, String> PROPERTIES
            = CoreUtils.getProperties("azure-resourcemanager-compute-disk.properties");
         ...
         * @return the ComputeDisk service API instance.
         */
        public ComputeDiskManager authenticate(TokenCredential credential, AzureProfile profile) {
            Objects.requireNonNull(credential, "'credential' cannot be null.");
            Objects.requireNonNull(profile, "'profile' cannot be null.");
            ...
            userAgentBuilder.append("azsdk-java")
                .append("-")
                .append("com.azure.resourcemanager.compute.disk")
                .append("/")
            ...
            HttpPipeline httpPipeline = new HttpPipelineBuilder().httpClient(httpClient)
                ...
                .build();
            return new ComputeDiskManager(httpPipeline, profile, defaultPollInterval);
        }
    }

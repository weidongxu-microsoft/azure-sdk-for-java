...
import com.azure.resourcemanager.compute.compute.fluent.VirtualMachineRunCommandsClient;
...
import com.azure.resourcemanager.compute.compute.implementation.models.VirtualMachineRunCommandsListResult;
...
public final class VirtualMachineRunCommandsClientImpl implements VirtualMachineRunCommandsClient {
    ...
    public interface VirtualMachineRunCommandsService {
        ...
        Mono<Response<VirtualMachineRunCommandInner>> getByVirtualMachine(@HostParam("endpoint") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<VirtualMachineRunCommandInner> getByVirtualMachineSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("vmName") String vmName,
            @PathParam("runCommandName") String runCommandName, @QueryParam("$expand") String expand,
            @HeaderParam("Accept") String accept, Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(@HostParam("endpoint") String endpoint,
            ...
            @BodyParam("application/json") VirtualMachineRunCommandInner runCommand, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<VirtualMachineRunCommandsListResult>> listByVirtualMachine(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("vmName") String vmName,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<VirtualMachineRunCommandsListResult> listByVirtualMachineSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("vmName") String vmName,
            @QueryParam("$expand") String expand, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<RunCommandListResult>> list(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<RunCommandListResult> listSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("location") String location, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<RunCommandDocumentInner>> get(@HostParam("endpoint") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<RunCommandDocumentInner> getSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("location") String location,
            @PathParam("commandId") String commandId, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<VirtualMachineRunCommandsListResult> listByVirtualMachineNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("endpoint") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<RunCommandListResult> listNextSync(@PathParam(value = "nextLink", encoded = true) String nextLink,
            @HostParam("endpoint") String endpoint, @HeaderParam("Accept") String accept, Context context);
    }
    ...
    private Mono<Response<VirtualMachineRunCommandInner>> getByVirtualMachineWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.getByVirtualMachine(this.client.getEndpoint(), this.client.getApiVersion(),
    ...
    public Response<VirtualMachineRunCommandInner> getByVirtualMachineWithResponse(String resourceGroupName,
        ...
        final String accept = "application/json";
        return service.getByVirtualMachineSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, vmName, runCommandName, expand, accept, context);
    }
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String vmName,
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, vmName, runCommandName, contentType, accept, runCommand,
            Context.NONE);
    }
    ...
    public SyncPoller<PollResult<VirtualMachineRunCommandInner>, VirtualMachineRunCommandInner> beginCreateOrUpdate(
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, vmName, runCommandName, runCommand);
    ...
    public SyncPoller<PollResult<VirtualMachineRunCommandInner>, VirtualMachineRunCommandInner> beginCreateOrUpdate(
        ...
        Context context) {
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, vmName, runCommandName, runCommand, context);
        return this.client.<VirtualMachineRunCommandInner, VirtualMachineRunCommandInner>getLroResult(response,
    ...
    public VirtualMachineRunCommandInner createOrUpdate(String resourceGroupName, String vmName, String runCommandName,
        VirtualMachineRunCommandInner runCommand) {
        return beginCreateOrUpdate(resourceGroupName, vmName, runCommandName, runCommand).getFinalResult();
    }
    ...
    public VirtualMachineRunCommandInner createOrUpdate(String resourceGroupName, String vmName, String runCommandName,
        ...
        return beginCreateOrUpdate(resourceGroupName, vmName, runCommandName, runCommand, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> updateWithResponse(String resourceGroupName, String vmName, String runCommandName,
    ...
    public SyncPoller<PollResult<VirtualMachineRunCommandInner>, VirtualMachineRunCommandInner> beginUpdate(
        String resourceGroupName, String vmName, String runCommandName, VirtualMachineRunCommandUpdate runCommand) {
        Response<BinaryData> response = updateWithResponse(resourceGroupName, vmName, runCommandName, runCommand);
        return this.client.<VirtualMachineRunCommandInner, VirtualMachineRunCommandInner>getLroResult(response,
            VirtualMachineRunCommandInner.class, VirtualMachineRunCommandInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<VirtualMachineRunCommandInner>, VirtualMachineRunCommandInner> beginUpdate(
        ...
        Context context) {
        Response<BinaryData> response
            = updateWithResponse(resourceGroupName, vmName, runCommandName, runCommand, context);
        return this.client.<VirtualMachineRunCommandInner, VirtualMachineRunCommandInner>getLroResult(response,
            VirtualMachineRunCommandInner.class, VirtualMachineRunCommandInner.class, context);
    }
    ...
    public VirtualMachineRunCommandInner update(String resourceGroupName, String vmName, String runCommandName,
        VirtualMachineRunCommandUpdate runCommand) {
        return beginUpdate(resourceGroupName, vmName, runCommandName, runCommand).getFinalResult();
    }
    ...
    public VirtualMachineRunCommandInner update(String resourceGroupName, String vmName, String runCommandName,
        VirtualMachineRunCommandUpdate runCommand, Context context) {
        return beginUpdate(resourceGroupName, vmName, runCommandName, runCommand, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String vmName, String runCommandName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        return service.deleteSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, vmName, runCommandName, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String vmName,
        String runCommandName) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, vmName, runCommandName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String vmName,
        ...
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, vmName, runCommandName, context);
    ...
    public void delete(String resourceGroupName, String vmName, String runCommandName) {
        beginDelete(resourceGroupName, vmName, runCommandName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String vmName, String runCommandName, Context context) {
        beginDelete(resourceGroupName, vmName, runCommandName, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<VirtualMachineRunCommandInner> listByVirtualMachineSinglePage(String resourceGroupName,
        ...
        Response<VirtualMachineRunCommandsListResult> res
            = service.listByVirtualMachineSync(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, vmName, expand, accept, Context.NONE);
    ...
    public PagedIterable<VirtualMachineRunCommandInner> listByVirtualMachine(String resourceGroupName, String vmName) {
        final String expand = null;
        return new PagedIterable<>(() -> listByVirtualMachineSinglePage(resourceGroupName, vmName, expand),
    ...
    public PagedIterable<VirtualMachineRunCommandInner> listByVirtualMachine(String resourceGroupName, String vmName,
        ...
        return new PagedIterable<>(() -> listByVirtualMachineSinglePage(resourceGroupName, vmName, expand, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<RunCommandDocumentBaseInner> listSinglePage(String location) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String accept = "application/json";
        Response<RunCommandListResult> res = service.listSync(this.client.getEndpoint(), this.client.getApiVersion(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<RunCommandDocumentBaseInner> listSinglePage(String location, Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
    ...
    private Mono<Response<RunCommandDocumentInner>> getWithResponseAsync(String location, String commandId) {
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), this.client.getApiVersion(), location,
                commandId, this.client.getSubscriptionId(), accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    public Response<RunCommandDocumentInner> getWithResponse(String location, String commandId, Context context) {
        ...
        if (commandId == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter commandId is required and cannot be null."));
        }
        if (this.client.getSubscriptionId() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), this.client.getApiVersion(), location, commandId,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<VirtualMachineRunCommandInner> listByVirtualMachineNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<RunCommandDocumentBaseInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<RunCommandListResult> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<RunCommandDocumentBaseInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<RunCommandListResult> res = service.listNextSync(nextLink, this.client.getEndpoint(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }

    private static final ClientLogger LOGGER = new ClientLogger(VirtualMachineRunCommandsClientImpl.class);
}

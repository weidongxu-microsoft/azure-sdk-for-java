...
import com.azure.resourcemanager.compute.compute.fluent.AvailabilitySetsClient;
import com.azure.resourcemanager.compute.compute.fluent.models.AvailabilitySetInner;
import com.azure.resourcemanager.compute.compute.fluent.models.VirtualMachineSizeInner;
import com.azure.resourcemanager.compute.compute.implementation.models.AvailabilitySetListResult;
...
import com.azure.resourcemanager.compute.compute.models.AvailabilitySetUpdate;
...
public final class AvailabilitySetsClientImpl implements AvailabilitySetsClient {
    ...
    public interface AvailabilitySetsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<AvailabilitySetInner> getByResourceGroupSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("availabilitySetName") String availabilitySetName, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<AvailabilitySetInner>> createOrUpdate(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("availabilitySetName") String availabilitySetName,
            @HeaderParam("Content-Type") String contentType, @HeaderParam("Accept") String accept,
            @BodyParam("application/json") AvailabilitySetInner parameters, Context context);

        @Put("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/availabilitySets/{availabilitySetName}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<AvailabilitySetInner> createOrUpdateSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("availabilitySetName") String availabilitySetName,
            @HeaderParam("Content-Type") String contentType, @HeaderParam("Accept") String accept,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<AvailabilitySetInner>> update(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("availabilitySetName") String availabilitySetName,
            @HeaderParam("Content-Type") String contentType, @HeaderParam("Accept") String accept,
            @BodyParam("application/json") AvailabilitySetUpdate parameters, Context context);

        @Patch("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/availabilitySets/{availabilitySetName}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<AvailabilitySetInner> updateSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("availabilitySetName") String availabilitySetName,
            @HeaderParam("Content-Type") String contentType, @HeaderParam("Accept") String accept,
        ...
        Mono<Response<Void>> delete(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("availabilitySetName") String availabilitySetName, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<AvailabilitySetListResult> listByResourceGroupSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<AvailabilitySetListResult> listSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("$expand") String expand, @HeaderParam("Accept") String accept, Context context);
        ...
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<Void>> startMigrationToVirtualMachineScaleSet(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("availabilitySetName") String availabilitySetName,
            @HeaderParam("Content-Type") String contentType,
            @BodyParam("application/json") MigrateToVirtualMachineScaleSetInput parameters, Context context);

        @Headers({ "Accept: application/json;q=0.9" })
        @Post("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/availabilitySets/{availabilitySetName}/startMigrationToVirtualMachineScaleSet")
        @ExpectedResponses({ 204 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<Void> startMigrationToVirtualMachineScaleSetSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("availabilitySetName") String availabilitySetName,
            @HeaderParam("Content-Type") String contentType,
        ...
        @ExpectedResponses({ 204 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<Void>> cancelMigrationToVirtualMachineScaleSet(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("availabilitySetName") String availabilitySetName, Context context);
        ...
        @ExpectedResponses({ 204 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<Void> cancelMigrationToVirtualMachineScaleSetSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("availabilitySetName") String availabilitySetName, Context context);
        ...
        @ExpectedResponses({ 204 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<Void>> validateMigrationToVirtualMachineScaleSet(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("availabilitySetName") String availabilitySetName,
            @HeaderParam("Content-Type") String contentType,
        ...
        @ExpectedResponses({ 204 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<Void> validateMigrationToVirtualMachineScaleSetSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("availabilitySetName") String availabilitySetName,
            @HeaderParam("Content-Type") String contentType,
        ...
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<Flux<ByteBuffer>>> convertToVirtualMachineScaleSet(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("availabilitySetName") String availabilitySetName,
            @BodyParam("application/json") ConvertToVirtualMachineScaleSetInput parameters, Context context);

        @Headers({ "Accept: application/json;q=0.9", "Content-Type: application/json" })
        @Post("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/availabilitySets/{availabilitySetName}/convertToVirtualMachineScaleSet")
        @ExpectedResponses({ 202 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<BinaryData> convertToVirtualMachineScaleSetSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("availabilitySetName") String availabilitySetName,
            @BodyParam("application/json") ConvertToVirtualMachineScaleSetInput parameters, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<AvailabilitySetListResult> listNextSync(@PathParam(value = "nextLink", encoded = true) String nextLink,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<AvailabilitySetListResult> listBySubscriptionNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("endpoint") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    ...
    public Response<AvailabilitySetInner> getByResourceGroupWithResponse(String resourceGroupName,
        ...
        if (availabilitySetName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter availabilitySetName is required and cannot be null."));
        }
        final String accept = "application/json";
    ...
    private Mono<Response<AvailabilitySetInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, availabilitySetName, contentType, accept,
                parameters, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    public Response<AvailabilitySetInner> createOrUpdateWithResponse(String resourceGroupName,
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, availabilitySetName, contentType, accept, parameters,
            context);
    }
     ...
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the List Availability Set operation response along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<AvailabilitySetInner> listByResourceGroupSinglePage(String resourceGroupName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String accept = "application/json";
        Response<AvailabilitySetListResult> res = service.listByResourceGroupSync(this.client.getEndpoint(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<AvailabilitySetInner> listSinglePage(String expand) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String accept = "application/json";
        Response<AvailabilitySetListResult> res = service.listSync(this.client.getEndpoint(),
            this.client.getApiVersion(), this.client.getSubscriptionId(), expand, accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<AvailabilitySetInner> listSinglePage(String expand, Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
    ...
    private PagedResponse<VirtualMachineSizeInner> listAvailableSizesSinglePage(String resourceGroupName,
        ...
        Response<VirtualMachineSizeListResult> res
            = service.listAvailableSizesSync(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, availabilitySetName, accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    public PagedIterable<VirtualMachineSizeInner> listAvailableSizes(String resourceGroupName,
        String availabilitySetName) {
        return new PagedIterable<>(() -> listAvailableSizesSinglePage(resourceGroupName, availabilitySetName),
    ...
    public PagedIterable<VirtualMachineSizeInner> listAvailableSizes(String resourceGroupName,
        String availabilitySetName, Context context) {
        return new PagedIterable<>(() -> listAvailableSizesSinglePage(resourceGroupName, availabilitySetName, context),
    ...
    private Mono<Response<Void>> startMigrationToVirtualMachineScaleSetWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.startMigrationToVirtualMachineScaleSet(this.client.getEndpoint(),
                this.client.getApiVersion(), this.client.getSubscriptionId(), resourceGroupName, availabilitySetName,
    ...
    public Response<Void> startMigrationToVirtualMachineScaleSetWithResponse(String resourceGroupName,
        ...
        final String contentType = "application/json";
        return service.startMigrationToVirtualMachineScaleSetSync(this.client.getEndpoint(),
            this.client.getApiVersion(), this.client.getSubscriptionId(), resourceGroupName, availabilitySetName,
            contentType, parameters, context);
    }
    ...
    public Response<Void> cancelMigrationToVirtualMachineScaleSetWithResponse(String resourceGroupName,
        ...
        return service.cancelMigrationToVirtualMachineScaleSetSync(this.client.getEndpoint(),
            this.client.getApiVersion(), this.client.getSubscriptionId(), resourceGroupName, availabilitySetName,
            context);
    }
    ...
    public Response<Void> validateMigrationToVirtualMachineScaleSetWithResponse(String resourceGroupName,
        ...
        final String contentType = "application/json";
        return service.validateMigrationToVirtualMachineScaleSetSync(this.client.getEndpoint(),
            this.client.getApiVersion(), this.client.getSubscriptionId(), resourceGroupName, availabilitySetName,
            contentType, parameters, context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> convertToVirtualMachineScaleSetWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.convertToVirtualMachineScaleSet(this.client.getEndpoint(),
                this.client.getApiVersion(), this.client.getSubscriptionId(), resourceGroupName, availabilitySetName,
                parameters, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> convertToVirtualMachineScaleSetWithResponse(String resourceGroupName,
        String availabilitySetName, ConvertToVirtualMachineScaleSetInput parameters) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        return service.convertToVirtualMachineScaleSetSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, availabilitySetName, parameters, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginConvertToVirtualMachineScaleSet(String resourceGroupName,
        ...
        Response<BinaryData> response
            = convertToVirtualMachineScaleSetWithResponse(resourceGroupName, availabilitySetName, parameters);
    ...
    public SyncPoller<PollResult<Void>, Void> beginConvertToVirtualMachineScaleSet(String resourceGroupName,
        String availabilitySetName, ConvertToVirtualMachineScaleSetInput parameters, Context context) {
        Response<BinaryData> response
            = convertToVirtualMachineScaleSetWithResponse(resourceGroupName, availabilitySetName, parameters, context);
    ...
    public void convertToVirtualMachineScaleSet(String resourceGroupName, String availabilitySetName) {
        final ConvertToVirtualMachineScaleSetInput parameters = null;
        beginConvertToVirtualMachineScaleSet(resourceGroupName, availabilitySetName, parameters).getFinalResult();
    }
    ...
    public void convertToVirtualMachineScaleSet(String resourceGroupName, String availabilitySetName,
        ...
        beginConvertToVirtualMachineScaleSet(resourceGroupName, availabilitySetName, parameters, context)
            .getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<AvailabilitySetInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<AvailabilitySetListResult> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<AvailabilitySetInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<AvailabilitySetInner> listBySubscriptionNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<AvailabilitySetInner> listBySubscriptionNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(AvailabilitySetsClientImpl.class);
}

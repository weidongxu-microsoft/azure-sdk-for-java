...
public final class UsagesClientImpl implements UsagesClient {
     ...
     */
    UsagesClientImpl(AzureComputeResourceManagementApiImpl client) {
        this.service = RestProxy.create(UsagesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for AzureComputeResourceManagementApiUsages to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "AzureComputeResourceManagementApiUsages")

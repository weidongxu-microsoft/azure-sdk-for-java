...
public final class VirtualMachineImagesEdgeZonesClientImpl implements VirtualMachineImagesEdgeZonesClient {
     ...
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "ComputeManagementClientVirtualMachineImagesEdgeZones")
    ...
    private Mono<Response<List<VirtualMachineImageResourceInner>>> listWithResponseAsync(String location,
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), location, edgeZone, publisherName, offer, skus, expand, top, orderby,
                accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<VirtualMachineImageInner>> getWithResponseAsync(String location, String edgeZone,
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), this.client.getApiVersion(), location,
                edgeZone, publisherName, offer, skus, version, this.client.getSubscriptionId(), accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    public Response<VirtualMachineImageInner> getWithResponse(String location, String edgeZone, String publisherName,
        ...
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), this.client.getApiVersion(), location, edgeZone,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(VirtualMachineImagesEdgeZonesClientImpl.class);
}

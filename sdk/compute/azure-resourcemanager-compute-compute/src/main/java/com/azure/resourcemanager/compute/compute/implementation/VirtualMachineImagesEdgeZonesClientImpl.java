...
public final class VirtualMachineImagesEdgeZonesClientImpl implements VirtualMachineImagesEdgeZonesClient {
     ...
     */
    VirtualMachineImagesEdgeZonesClientImpl(AzureComputeResourceManagementApiImpl client) {
    ...
    /**
     * The interface defining all the services for AzureComputeResourceManagementApiVirtualMachineImagesEdgeZones to be
     * used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "AzureComputeResourceManagementApiVirtualMachineImagesEdgeZones")

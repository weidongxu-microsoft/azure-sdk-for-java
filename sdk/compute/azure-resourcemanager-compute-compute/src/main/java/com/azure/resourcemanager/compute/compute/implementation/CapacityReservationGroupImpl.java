...
import com.azure.resourcemanager.compute.compute.models.CapacityReservationGroupInstanceView;
...
import com.azure.resourcemanager.compute.compute.models.SubResourceReadOnly;
...
public final class CapacityReservationGroupImpl
    ...
    public ReservationType reservationType() {
        return this.innerModel().reservationType();
    }
    ...
    public CapacityReservationGroup create() {
        this.innerObject = serviceManager.serviceClient()
            ...
            .createOrUpdateWithResponse(resourceGroupName, capacityReservationGroupName, this.innerModel(),
                Context.NONE)
            .getValue();
        return this;
    }
    ...
    CapacityReservationGroupImpl(String name, com.azure.resourcemanager.compute.compute.ComputeManager serviceManager) {
    ...
    public CapacityReservationGroupImpl withReservationType(ReservationType reservationType) {
        if (isInCreateMode()) {
            this.innerModel().withReservationType(reservationType);
            return this;
        } else {
            this.updateParameters.withReservationType(reservationType);
            return this;
        }
    }

...
public interface AvailabilitySet {
    ...
    /**
     * Gets the inner com.azure.resourcemanager.compute.compute.fluent.models.AvailabilitySetInner object.
     * 
     ...
     * @return the {@link Response}.
     */
    Response<Void> startMigrationToVirtualMachineScaleSetWithResponse(MigrateToVirtualMachineScaleSetInput parameters,
        Context context);
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void startMigrationToVirtualMachineScaleSet(MigrateToVirtualMachineScaleSetInput parameters);
     ...
     * @return the {@link Response}.
     */
    Response<Void> validateMigrationToVirtualMachineScaleSetWithResponse(
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void validateMigrationToVirtualMachineScaleSet(MigrateToVirtualMachineScaleSetInput parameters);
}

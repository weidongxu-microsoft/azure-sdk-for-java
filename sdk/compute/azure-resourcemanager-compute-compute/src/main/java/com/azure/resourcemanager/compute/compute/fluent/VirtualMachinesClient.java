...
package com.azure.resourcemanager.compute.compute.fluent;
...
public interface VirtualMachinesClient {
     ...
     * @throws com.azure.resourcemanager.compute.compute.models.ApiErrorException thrown if the request is rejected by
     * server.

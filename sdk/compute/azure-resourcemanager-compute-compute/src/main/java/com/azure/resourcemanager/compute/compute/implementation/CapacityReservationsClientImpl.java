...
import com.azure.resourcemanager.compute.compute.fluent.CapacityReservationsClient;
...
import com.azure.resourcemanager.compute.compute.models.CapacityReservationUpdate;
...
public final class CapacityReservationsClientImpl implements CapacityReservationsClient {
     ...
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "ComputeManagementClientCapacityReservations")
    public interface CapacityReservationsService {
        ...
        Mono<Response<CapacityReservationInner>> get(@HostParam("endpoint") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<CapacityReservationInner> getSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("capacityReservationGroupName") String capacityReservationGroupName,
            @PathParam("capacityReservationName") String capacityReservationName,
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(@HostParam("endpoint") String endpoint,
            ...
            @BodyParam("application/json") CapacityReservationInner parameters, Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> update(@HostParam("endpoint") String endpoint,
            ...
            @PathParam("capacityReservationName") String capacityReservationName,
            @HeaderParam("Content-Type") String contentType, @HeaderParam("Accept") String accept,
            @BodyParam("application/json") CapacityReservationUpdate parameters, Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> delete(@HostParam("endpoint") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("capacityReservationGroupName") String capacityReservationGroupName,
            @PathParam("capacityReservationName") String capacityReservationName, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<CapacityReservationListResult> listByCapacityReservationGroupSync(
            @HostParam("endpoint") String endpoint, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("capacityReservationGroupName") String capacityReservationGroupName,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<CapacityReservationListResult> listByCapacityReservationGroupNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("endpoint") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    private Mono<Response<CapacityReservationInner>> getWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), this.client.getApiVersion(),
                ...
                capacityReservationName, expand, accept, context))
    ...
    public Response<CapacityReservationInner> getWithResponse(String resourceGroupName,
        ...
        if (capacityReservationName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter capacityReservationName is required and cannot be null."));
        }
        final String accept = "application/json";
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, capacityReservationGroupName,
                capacityReservationName, contentType, accept, parameters, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    public SyncPoller<PollResult<CapacityReservationInner>, CapacityReservationInner> beginCreateOrUpdate(
        String resourceGroupName, String capacityReservationGroupName, String capacityReservationName,
        CapacityReservationInner parameters) {
        Response<BinaryData> response = createOrUpdateWithResponse(resourceGroupName, capacityReservationGroupName,
            capacityReservationName, parameters);
        return this.client.<CapacityReservationInner, CapacityReservationInner>getLroResult(response,
            CapacityReservationInner.class, CapacityReservationInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<CapacityReservationInner>, CapacityReservationInner> beginCreateOrUpdate(
        ...
        return this.client.<CapacityReservationInner, CapacityReservationInner>getLroResult(response,
            CapacityReservationInner.class, CapacityReservationInner.class, context);
    }
    ...
    public CapacityReservationInner createOrUpdate(String resourceGroupName, String capacityReservationGroupName,
        ...
        return beginCreateOrUpdate(resourceGroupName, capacityReservationGroupName, capacityReservationName, parameters)
            .getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> updateWithResponse(String resourceGroupName, String capacityReservationGroupName,
    ...
    public SyncPoller<PollResult<CapacityReservationInner>, CapacityReservationInner> beginUpdate(
        ...
        Response<BinaryData> response
            = updateWithResponse(resourceGroupName, capacityReservationGroupName, capacityReservationName, parameters);
        return this.client.<CapacityReservationInner, CapacityReservationInner>getLroResult(response,
            CapacityReservationInner.class, CapacityReservationInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<CapacityReservationInner>, CapacityReservationInner> beginUpdate(
        ...
        Response<BinaryData> response = updateWithResponse(resourceGroupName, capacityReservationGroupName,
            capacityReservationName, parameters, context);
        return this.client.<CapacityReservationInner, CapacityReservationInner>getLroResult(response,
            CapacityReservationInner.class, CapacityReservationInner.class, context);
    }
    ...
    public CapacityReservationInner update(String resourceGroupName, String capacityReservationGroupName,
        String capacityReservationName, CapacityReservationUpdate parameters) {
        return beginUpdate(resourceGroupName, capacityReservationGroupName, capacityReservationName, parameters)
            .getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String capacityReservationGroupName,
        String capacityReservationName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String capacityReservationGroupName,
        String capacityReservationName) {
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, capacityReservationGroupName, capacityReservationName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String capacityReservationGroupName,
        String capacityReservationName, Context context) {
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, capacityReservationGroupName, capacityReservationName, context);
    ...
    public void delete(String resourceGroupName, String capacityReservationGroupName, String capacityReservationName) {
        beginDelete(resourceGroupName, capacityReservationGroupName, capacityReservationName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String capacityReservationGroupName, String capacityReservationName,
        Context context) {
        beginDelete(resourceGroupName, capacityReservationGroupName, capacityReservationName, context).getFinalResult();
    }
    ...
    private Mono<PagedResponse<CapacityReservationInner>>
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listByCapacityReservationGroup(this.client.getEndpoint(),
     ...
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the list capacity reservation operation response along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<CapacityReservationInner> listByCapacityReservationGroupSinglePage(String resourceGroupName,
        String capacityReservationGroupName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String accept = "application/json";
        Response<CapacityReservationListResult> res
            = service.listByCapacityReservationGroupSync(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, capacityReservationGroupName, accept, Context.NONE);
    ...
    public PagedIterable<CapacityReservationInner> listByCapacityReservationGroup(String resourceGroupName,
        ...
        return new PagedIterable<>(
            () -> listByCapacityReservationGroupSinglePage(resourceGroupName, capacityReservationGroupName),
            nextLink -> listByCapacityReservationGroupNextSinglePage(nextLink));
    }
    ...
    public PagedIterable<CapacityReservationInner> listByCapacityReservationGroup(String resourceGroupName,
        String capacityReservationGroupName, Context context) {
        return new PagedIterable<>(
            () -> listByCapacityReservationGroupSinglePage(resourceGroupName, capacityReservationGroupName, context),
            nextLink -> listByCapacityReservationGroupNextSinglePage(nextLink, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<CapacityReservationInner> listByCapacityReservationGroupNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<CapacityReservationListResult> res
            = service.listByCapacityReservationGroupNextSync(nextLink, this.client.getEndpoint(), accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    private PagedResponse<CapacityReservationInner> listByCapacityReservationGroupNextSinglePage(String nextLink,
        ...
        final String accept = "application/json";
        Response<CapacityReservationListResult> res
            = service.listByCapacityReservationGroupNextSync(nextLink, this.client.getEndpoint(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }

    private static final ClientLogger LOGGER = new ClientLogger(CapacityReservationsClientImpl.class);
}

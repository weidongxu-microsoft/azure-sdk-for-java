...
public final class CapacityReservationsClientImpl implements CapacityReservationsClient {
     ...
     */
    CapacityReservationsClientImpl(AzureComputeResourceManagementApiImpl client) {
    ...
    /**
     * The interface defining all the services for AzureComputeResourceManagementApiCapacityReservations to be used by
     * the proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "AzureComputeResourceManagementApiCapacityReservations")
    public interface CapacityReservationsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<CapacityReservationListResult> listByCapacityReservationGroupSync(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<CapacityReservationInner> getSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("capacityReservationGroupName") String capacityReservationGroupName,
            @PathParam("capacityReservationName") String capacityReservationName,
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.delete(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, capacityReservationGroupName,
                capacityReservationName, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }

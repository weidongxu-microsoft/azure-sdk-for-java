...
public interface VirtualMachineRunCommands {
     ...
     * @return the List run command operation response as paginated response with {@link PagedIterable}.
     */
    PagedIterable<VirtualMachineRunCommand> listByVirtualMachine(String resourceGroupName, String vmName, String expand,
        Context context);
     ...
     */
    Response<VirtualMachineRunCommand> getByVirtualMachineWithResponse(String resourceGroupName, String vmName,

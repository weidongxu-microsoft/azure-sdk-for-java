...
public final class DedicatedHostGroupsClientImpl implements DedicatedHostGroupsClient {
     ...
     */
    DedicatedHostGroupsClientImpl(AzureComputeResourceManagementApiImpl client) {
    ...
    /**
     * The interface defining all the services for AzureComputeResourceManagementApiDedicatedHostGroups to be used by
     * the proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "AzureComputeResourceManagementApiDedicatedHostGroups")

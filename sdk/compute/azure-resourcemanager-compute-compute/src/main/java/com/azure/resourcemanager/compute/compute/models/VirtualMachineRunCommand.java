...
public interface VirtualMachineRunCommand {
    ...
    /**
     * Gets the inner com.azure.resourcemanager.compute.compute.fluent.models.VirtualMachineRunCommandInner object.
     * 
    ...
    interface DefinitionStages {
        ...
        interface WithCreate extends DefinitionStages.WithTags, DefinitionStages.WithSource,
            DefinitionStages.WithParameters, DefinitionStages.WithProtectedParameters,
            DefinitionStages.WithAsyncExecution, DefinitionStages.WithRunAsUser, DefinitionStages.WithRunAsPassword,
            DefinitionStages.WithTimeoutInSeconds, DefinitionStages.WithOutputBlobUri,
            DefinitionStages.WithErrorBlobUri, DefinitionStages.WithOutputBlobManagedIdentity,
            DefinitionStages.WithErrorBlobManagedIdentity, DefinitionStages.WithTreatFailureAsDeploymentFailure {
            /**
        ...
        interface WithTreatFailureAsDeploymentFailure {
             ...
             * deployment and ProvisioningState will be marked as Failed. If set to false, ProvisioningState would only
             * reflect whether the run command was run or not by the extensions platform, it would not indicate whether
             * script failed in case of script failures. See instance view of run command in case of script failures to
             * see executionMessage, output, error: https://aka.ms/runcommandmanaged#get-execution-status-and-results.
             * @return the next definition stage.
             */
    ...
    interface Update extends UpdateStages.WithTags, UpdateStages.WithSource, UpdateStages.WithParameters,
        ...
        UpdateStages.WithErrorBlobManagedIdentity, UpdateStages.WithTreatFailureAsDeploymentFailure {
        /**

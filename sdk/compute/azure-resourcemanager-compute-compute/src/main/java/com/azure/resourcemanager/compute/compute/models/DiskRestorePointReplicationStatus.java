 ...
 */
@Immutable
public final class DiskRestorePointReplicationStatus implements JsonSerializable<DiskRestorePointReplicationStatus> {
    /*
     ...
     */
    private DiskRestorePointReplicationStatus() {
    }

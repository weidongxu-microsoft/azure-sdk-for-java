...
public interface StorageProfile {
    ...
    /**
     * Gets the alignRegionalDisksToVMZone property: Specifies whether the regional disks should be aligned/moved to the
     ...
     */
    Boolean alignRegionalDisksToVMZone();

    /**
     * Gets the inner com.azure.resourcemanager.compute.compute.fluent.models.StorageProfileInner object.
     * 

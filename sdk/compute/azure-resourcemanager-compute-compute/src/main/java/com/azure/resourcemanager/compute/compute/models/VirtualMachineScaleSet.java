...
public interface VirtualMachineScaleSet {
    ...
    /**
     * Gets the placement property: Placement section specifies the user-defined constraints for virtual machine scale
    ...
    /**
     * Gets the highSpeedInterconnectPlacement property: Specifies the high speed interconnect placement for the virtual
     * machine scale set.
     * 
    ...
    /**
     * Gets the inner com.azure.resourcemanager.compute.compute.fluent.models.VirtualMachineScaleSetInner object.
     * 
    ...
    interface DefinitionStages {
        ...
        interface WithCreate extends DefinitionStages.WithTags, DefinitionStages.WithSku, DefinitionStages.WithPlan,
            ...
            DefinitionStages.WithPlacement, DefinitionStages.WithUpgradePolicy,
            DefinitionStages.WithScheduledEventsPolicy, DefinitionStages.WithAutomaticRepairsPolicy,
            ...
            DefinitionStages.WithResiliencyPolicy, DefinitionStages.WithZonalPlatformFaultDomainAlignMode,
            DefinitionStages.WithSkuProfile, DefinitionStages.WithHighSpeedInterconnectPlacement,
        ...
        /**
         * The stage of the VirtualMachineScaleSet definition allowing to specify placement.
         */
        interface WithPlacement {
             ...
             * machine scale set hardware placement. This property cannot be changed once VMSS is provisioned. Minimum
             * api-version: 2025-04-01..
             * 
             * @param placement Placement section specifies the user-defined constraints for virtual machine scale set
             * hardware placement. This property cannot be changed once VMSS is provisioned. Minimum api-version:
             * 2025-04-01.
             * @return the next definition stage.
             */
        ...
        /**
         * The stage of the VirtualMachineScaleSet definition allowing to specify highSpeedInterconnectPlacement.
         */
        interface WithHighSpeedInterconnectPlacement {
            /**
             * Specifies the highSpeedInterconnectPlacement property: Specifies the high speed interconnect placement
             * for the virtual machine scale set..
             * 
             * @param highSpeedInterconnectPlacement Specifies the high speed interconnect placement for the virtual
             * machine scale set.
             * @return the next definition stage.
             */
            WithCreate
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void scaleOut(VMScaleSetScaleOutInput parameters);
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void scaleOut(VMScaleSetScaleOutInput parameters, Context context);

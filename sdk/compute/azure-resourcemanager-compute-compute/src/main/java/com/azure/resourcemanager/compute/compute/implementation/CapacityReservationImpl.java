...
import com.azure.resourcemanager.compute.compute.models.CapacityReservationInstanceView;
...
public final class CapacityReservationImpl
    ...
    public ScheduleProfile scheduleProfile() {
        return this.innerModel().scheduleProfile();
    }
    ...
    CapacityReservationImpl(String name, com.azure.resourcemanager.compute.compute.ComputeManager serviceManager) {
    ...
    public CapacityReservationImpl withScheduleProfile(ScheduleProfile scheduleProfile) {
        if (isInCreateMode()) {
            this.innerModel().withScheduleProfile(scheduleProfile);
            return this;
        } else {
            this.updateParameters.withScheduleProfile(scheduleProfile);
            return this;
        }
    }

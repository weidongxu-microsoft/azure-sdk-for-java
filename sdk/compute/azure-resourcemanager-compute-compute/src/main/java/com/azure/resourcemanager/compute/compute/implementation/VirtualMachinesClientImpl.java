...
import com.azure.resourcemanager.compute.compute.models.VirtualMachineListResult;
...
public final class VirtualMachinesClientImpl implements VirtualMachinesClient {
     ...
     */
    VirtualMachinesClientImpl(AzureComputeResourceManagementApiImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AzureComputeResourceManagementApiVirtualMachines to be used by the
     * proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "AzureComputeResourceManagementApiVirtualMachines")
    public interface VirtualMachinesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<Void> generalizeSync(@HostParam("$host") String endpoint, @QueryParam("api-version") String apiVersion,
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String vmName, Boolean forceDeletion) {
        ...
        return service.deleteSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, vmName, forceDeletion, accept, Context.NONE);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> attachDetachDataDisksWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(
                context -> service.attachDetachDataDisks(this.client.getEndpoint(), this.client.getApiVersion(),
    ...
    private Response<BinaryData> attachDetachDataDisksWithResponse(String resourceGroupName, String vmName,
        ...
        return service.attachDetachDataDisksSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, vmName, parameters, accept, Context.NONE);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> convertToManagedDisksWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(
                context -> service.convertToManagedDisks(this.client.getEndpoint(), this.client.getApiVersion(),
                    this.client.getSubscriptionId(), resourceGroupName, vmName, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Response<BinaryData> deallocateWithResponse(String resourceGroupName, String vmName, Boolean hibernate) {
        ...
        return service.deallocateSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, vmName, hibernate, accept, Context.NONE);
    }
    ...
    private Response<BinaryData> installPatchesWithResponse(String resourceGroupName, String vmName,
        ...
        return service.installPatchesSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, vmName, installPatchesInput, accept, Context.NONE);
    }
    ...
    private Response<BinaryData> powerOffWithResponse(String resourceGroupName, String vmName, Boolean skipShutdown) {
        ...
        return service.powerOffSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, vmName, skipShutdown, accept, Context.NONE);
    }

...
import com.azure.resourcemanager.compute.compute.models.RestorePoint;
...
public final class RestorePointCollectionImpl
    ...
    public Boolean instantAccess() {
        return this.innerModel().instantAccess();
    }
    ...
    RestorePointCollectionImpl(String name, com.azure.resourcemanager.compute.compute.ComputeManager serviceManager) {
    ...
    public RestorePointCollectionImpl withInstantAccess(Boolean instantAccess) {
        if (isInCreateMode()) {
            this.innerModel().withInstantAccess(instantAccess);
            return this;
        } else {
            this.updateParameters.withInstantAccess(instantAccess);
            return this;
        }
    }

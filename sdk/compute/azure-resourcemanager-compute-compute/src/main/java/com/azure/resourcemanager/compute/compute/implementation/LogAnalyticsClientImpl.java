...
public final class LogAnalyticsClientImpl implements LogAnalyticsClient {
    ...
    public interface LogAnalyticsService {
        ...
        Mono<Response<Flux<ByteBuffer>>> exportRequestRateByInterval(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("location") String location, @HeaderParam("Content-Type") String contentType,
            @HeaderParam("Accept") String accept, @BodyParam("application/json") RequestRateByIntervalInput parameters,
            Context context);

        @Post("/subscriptions/{subscriptionId}/providers/Microsoft.Compute/locations/{location}/logAnalytics/apiAccess/getRequestRateByInterval")
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<BinaryData> exportRequestRateByIntervalSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("location") String location, @HeaderParam("Content-Type") String contentType,
            @HeaderParam("Accept") String accept, @BodyParam("application/json") RequestRateByIntervalInput parameters,
            Context context);
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<Flux<ByteBuffer>>> exportThrottledRequests(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("location") String location, @HeaderParam("Content-Type") String contentType,
            @HeaderParam("Accept") String accept, @BodyParam("application/json") ThrottledRequestsInput parameters,
            Context context);

        @Post("/subscriptions/{subscriptionId}/providers/Microsoft.Compute/locations/{location}/logAnalytics/apiAccess/getThrottledRequests")
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<BinaryData> exportThrottledRequestsSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("location") String location, @HeaderParam("Content-Type") String contentType,
            @HeaderParam("Accept") String accept, @BodyParam("application/json") ThrottledRequestsInput parameters,
            Context context);
    ...
    private Mono<Response<Flux<ByteBuffer>>> exportRequestRateByIntervalWithResponseAsync(String location,
        ...
        return FluxUtil
            .withContext(
                context -> service.exportRequestRateByInterval(this.client.getEndpoint(), this.client.getApiVersion(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> exportRequestRateByIntervalWithResponse(String location,
        RequestRateByIntervalInput parameters) {
        if (this.client.getEndpoint() == null) {
        ...
        final String contentType = "application/json";
        final String accept = "application/json";
        return service.exportRequestRateByIntervalSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), location, contentType, accept, parameters, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<LogAnalyticsOperationResultInner>, LogAnalyticsOperationResultInner>
        ...
        Response<BinaryData> response = exportRequestRateByIntervalWithResponse(location, parameters);
        return this.client.<LogAnalyticsOperationResultInner, LogAnalyticsOperationResultInner>getLroResult(response,
            LogAnalyticsOperationResultInner.class, LogAnalyticsOperationResultInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<LogAnalyticsOperationResultInner>, LogAnalyticsOperationResultInner>
        ...
        Response<BinaryData> response = exportRequestRateByIntervalWithResponse(location, parameters, context);
        return this.client.<LogAnalyticsOperationResultInner, LogAnalyticsOperationResultInner>getLroResult(response,
            LogAnalyticsOperationResultInner.class, LogAnalyticsOperationResultInner.class, context);
    }
    ...
    public LogAnalyticsOperationResultInner exportRequestRateByInterval(String location,
        RequestRateByIntervalInput parameters) {
        return beginExportRequestRateByInterval(location, parameters).getFinalResult();
    }
    ...
    public LogAnalyticsOperationResultInner exportRequestRateByInterval(String location,
        RequestRateByIntervalInput parameters, Context context) {
        return beginExportRequestRateByInterval(location, parameters, context).getFinalResult();
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> exportThrottledRequestsWithResponseAsync(String location,
        ...
        return FluxUtil
            .withContext(
                context -> service.exportThrottledRequests(this.client.getEndpoint(), this.client.getApiVersion(),
                    this.client.getSubscriptionId(), location, contentType, accept, parameters, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> exportThrottledRequestsWithResponse(String location,
        ThrottledRequestsInput parameters) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String contentType = "application/json";
        final String accept = "application/json";
        return service.exportThrottledRequestsSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), location, contentType, accept, parameters, Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> exportThrottledRequestsWithResponse(String location, ThrottledRequestsInput parameters,
        Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
    ...
    public SyncPoller<PollResult<LogAnalyticsOperationResultInner>, LogAnalyticsOperationResultInner>
        ...
        Response<BinaryData> response = exportThrottledRequestsWithResponse(location, parameters);
        return this.client.<LogAnalyticsOperationResultInner, LogAnalyticsOperationResultInner>getLroResult(response,
            LogAnalyticsOperationResultInner.class, LogAnalyticsOperationResultInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<LogAnalyticsOperationResultInner>, LogAnalyticsOperationResultInner>
        ...
        Response<BinaryData> response = exportThrottledRequestsWithResponse(location, parameters, context);
        return this.client.<LogAnalyticsOperationResultInner, LogAnalyticsOperationResultInner>getLroResult(response,
            LogAnalyticsOperationResultInner.class, LogAnalyticsOperationResultInner.class, context);
    }
    ...
    public LogAnalyticsOperationResultInner exportThrottledRequests(String location,
        ThrottledRequestsInput parameters) {
        return beginExportThrottledRequests(location, parameters).getFinalResult();
    }
    ...
    public LogAnalyticsOperationResultInner exportThrottledRequests(String location, ThrottledRequestsInput parameters,
        Context context) {
        return beginExportThrottledRequests(location, parameters, context).getFinalResult();
    }

    private static final ClientLogger LOGGER = new ClientLogger(LogAnalyticsClientImpl.class);
}

...
public final class LogAnalyticsClientImpl implements LogAnalyticsClient {
     ...
     */
    LogAnalyticsClientImpl(AzureComputeResourceManagementApiImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AzureComputeResourceManagementApiLogAnalytics to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "AzureComputeResourceManagementApiLogAnalytics")
    public interface LogAnalyticsService {
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<BinaryData> exportRequestRateByIntervalSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("location") String location,
            @BodyParam("application/json") RequestRateByIntervalInput parameters, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<BinaryData> exportThrottledRequestsSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("location") String location, @BodyParam("application/json") ThrottledRequestsInput parameters,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> exportRequestRateByIntervalWithResponseAsync(String location,
        ...
        return FluxUtil
            .withContext(context -> service.exportRequestRateByInterval(this.client.getEndpoint(),
     ...
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return logAnalytics operation status response along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> exportRequestRateByIntervalWithResponse(String location,
        ...
        return service.exportRequestRateByIntervalSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), location, parameters, accept, Context.NONE);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> exportThrottledRequestsWithResponseAsync(String location,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.exportThrottledRequests(this.client.getEndpoint(),
                this.client.getApiVersion(), this.client.getSubscriptionId(), location, parameters, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }

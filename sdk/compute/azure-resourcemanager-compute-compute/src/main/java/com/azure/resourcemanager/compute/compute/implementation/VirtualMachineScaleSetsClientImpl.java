...
import com.azure.resourcemanager.compute.compute.fluent.VirtualMachineScaleSetsClient;
import com.azure.resourcemanager.compute.compute.fluent.models.RecoveryWalkResponseInner;
import com.azure.resourcemanager.compute.compute.fluent.models.UpgradeOperationHistoricalStatusInfoInner;
import com.azure.resourcemanager.compute.compute.fluent.models.VirtualMachineScaleSetInner;
import com.azure.resourcemanager.compute.compute.fluent.models.VirtualMachineScaleSetInstanceViewInner;
import com.azure.resourcemanager.compute.compute.fluent.models.VirtualMachineScaleSetSkuInner;
import com.azure.resourcemanager.compute.compute.implementation.models.VirtualMachineScaleSetListOSUpgradeHistory;
import com.azure.resourcemanager.compute.compute.implementation.models.VirtualMachineScaleSetListResult;
import com.azure.resourcemanager.compute.compute.implementation.models.VirtualMachineScaleSetListSkusResult;
import com.azure.resourcemanager.compute.compute.implementation.models.VirtualMachineScaleSetListWithLinkResult;
...
import com.azure.resourcemanager.compute.compute.models.VirtualMachineScaleSetUpdate;
...
public final class VirtualMachineScaleSetsClientImpl implements VirtualMachineScaleSetsClient {
    ...
    public interface VirtualMachineScaleSetsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<VirtualMachineScaleSetInner> getByResourceGroupSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vmScaleSetName") String vmScaleSetName,
            @QueryParam("$expand") ExpandTypesForGetVMScaleSets expand, @HeaderParam("Accept") String accept,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<VirtualMachineScaleSetListResult> listByResourceGroupSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<VirtualMachineScaleSetListWithLinkResult> listSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<Void> convertToSinglePlacementGroupSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vmScaleSetName") String vmScaleSetName, @HeaderParam("Content-Type") String contentType,
            @BodyParam("application/json") VMScaleSetConvertToSinglePlacementGroupInput parameters, Context context);
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<BinaryData> deleteInstancesSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vmScaleSetName") String vmScaleSetName, @QueryParam("forceDeletion") Boolean forceDeletion,
            @HeaderParam("Content-Type") String contentType,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<VirtualMachineScaleSetInstanceViewInner> getInstanceViewSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vmScaleSetName") String vmScaleSetName, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<BinaryData> updateInstancesSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vmScaleSetName") String vmScaleSetName, @HeaderParam("Content-Type") String contentType,
            @BodyParam("application/json") VirtualMachineScaleSetVMInstanceRequiredIDs vmInstanceIDs, Context context);
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<BinaryData> setOrchestrationServiceStateSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vmScaleSetName") String vmScaleSetName, @HeaderParam("Content-Type") String contentType,
            @BodyParam("application/json") OrchestrationServiceStateInput parameters, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<VirtualMachineScaleSetListSkusResult> listSkusSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vmScaleSetName") String vmScaleSetName, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<BinaryData> scaleOutSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vmScaleSetName") String vmScaleSetName, @HeaderParam("Content-Type") String contentType,
            @BodyParam("application/json") VMScaleSetScaleOutInput parameters, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<VirtualMachineScaleSetListResult> listByLocationSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("location") String location, @HeaderParam("Accept") String accept, Context context);
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String vmScaleSetName,
        ...
        return service.deleteSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName, forceDeletion, Context.NONE);
    }
    ...
    private PagedResponse<VirtualMachineScaleSetInner> listSinglePage() {
        ...
        final String accept = "application/json";
        Response<VirtualMachineScaleSetListWithLinkResult> res = service.listSync(this.client.getEndpoint(),
    ...
    private Response<BinaryData> approveRollingUpgradeWithResponse(String resourceGroupName, String vmScaleSetName,
        ...
        return service.approveRollingUpgradeSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName, vmInstanceIDs, Context.NONE);
    }
    ...
    private Mono<Response<Void>> convertToSinglePlacementGroupWithResponseAsync(String resourceGroupName,
        ...
        final String contentType = "application/json";
        return FluxUtil
            .withContext(context -> service.convertToSinglePlacementGroup(this.client.getEndpoint(),
    ...
    public Response<Void> convertToSinglePlacementGroupWithResponse(String resourceGroupName, String vmScaleSetName,
        ...
        final String contentType = "application/json";
        return service.convertToSinglePlacementGroupSync(this.client.getEndpoint(), this.client.getApiVersion(),
    ...
    private Response<BinaryData> deallocateWithResponse(String resourceGroupName, String vmScaleSetName,
        ...
        return service.deallocateSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName, hibernate, vmInstanceIDs, Context.NONE);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteInstancesWithResponseAsync(String resourceGroupName,
        ...
        final String contentType = "application/json";
        return FluxUtil
            .withContext(context -> service.deleteInstances(this.client.getEndpoint(), this.client.getApiVersion(),
    ...
    private Response<BinaryData> deleteInstancesWithResponse(String resourceGroupName, String vmScaleSetName,
        ...
        final String contentType = "application/json";
        return service.deleteInstancesSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName, forceDeletion, contentType,
            vmInstanceIDs, Context.NONE);
    }
    ...
    private Mono<Response<RecoveryWalkResponseInner>>
        ...
        return FluxUtil
            .withContext(context -> service.forceRecoveryServiceFabricPlatformUpdateDomainWalk(
                ...
                resourceGroupName, vmScaleSetName, platformUpdateDomain, zone, placementGroupId, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    public Response<RecoveryWalkResponseInner> forceRecoveryServiceFabricPlatformUpdateDomainWalkWithResponse(
        ...
        return service.forceRecoveryServiceFabricPlatformUpdateDomainWalkSync(this.client.getEndpoint(),
            this.client.getApiVersion(), this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName,
            platformUpdateDomain, zone, placementGroupId, accept, context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateInstancesWithResponseAsync(String resourceGroupName,
        ...
        final String contentType = "application/json";
        return FluxUtil
            .withContext(context -> service.updateInstances(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName, contentType, vmInstanceIDs,
                context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Response<BinaryData> updateInstancesWithResponse(String resourceGroupName, String vmScaleSetName,
        ...
        final String contentType = "application/json";
        return service.updateInstancesSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName, contentType, vmInstanceIDs,
            Context.NONE);
    }
    ...
    private Mono<PagedResponse<UpgradeOperationHistoricalStatusInfoInner>>
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.getOSUpgradeHistory(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName, accept, context))
    ...
    private PagedResponse<UpgradeOperationHistoricalStatusInfoInner>
        ...
        Response<VirtualMachineScaleSetListOSUpgradeHistory> res
            = service.getOSUpgradeHistorySync(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName, accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> powerOffWithResponseAsync(String resourceGroupName, String vmScaleSetName,
        ...
        return FluxUtil.withContext(context -> service.powerOff(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName, skipShutdown, vmInstanceIDs, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Response<BinaryData> powerOffWithResponse(String resourceGroupName, String vmScaleSetName,
        ...
        return service.powerOffSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName, skipShutdown, vmInstanceIDs,
            Context.NONE);
    }
    ...
    private Response<BinaryData> reapplyWithResponse(String resourceGroupName, String vmScaleSetName) {
        ...
        return service.reapplySync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName, Context.NONE);
    }
    ...
    private Response<BinaryData> reimageWithResponse(String resourceGroupName, String vmScaleSetName,
        ...
        return service.reimageSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName, vmScaleSetReimageInput, Context.NONE);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> setOrchestrationServiceStateWithResponseAsync(String resourceGroupName,
        ...
        final String contentType = "application/json";
        return FluxUtil
            .withContext(context -> service.setOrchestrationServiceState(this.client.getEndpoint(),
                this.client.getApiVersion(), this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName,
                contentType, parameters, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Response<BinaryData> setOrchestrationServiceStateWithResponse(String resourceGroupName,
        ...
        final String contentType = "application/json";
        return service.setOrchestrationServiceStateSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName, contentType, parameters, Context.NONE);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> scaleOutWithResponseAsync(String resourceGroupName, String vmScaleSetName,
        ...
        final String contentType = "application/json";
        return FluxUtil
            .withContext(context -> service.scaleOut(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName, contentType, parameters, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> scaleOutWithResponse(String resourceGroupName, String vmScaleSetName,
        VMScaleSetScaleOutInput parameters) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String contentType = "application/json";
        return service.scaleOutSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName, contentType, parameters, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginScaleOut(String resourceGroupName, String vmScaleSetName,
        VMScaleSetScaleOutInput parameters) {
        Response<BinaryData> response = scaleOutWithResponse(resourceGroupName, vmScaleSetName, parameters);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginScaleOut(String resourceGroupName, String vmScaleSetName,
        VMScaleSetScaleOutInput parameters, Context context) {
        Response<BinaryData> response = scaleOutWithResponse(resourceGroupName, vmScaleSetName, parameters, context);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, context);
    }
    ...
    public void scaleOut(String resourceGroupName, String vmScaleSetName, VMScaleSetScaleOutInput parameters) {
        beginScaleOut(resourceGroupName, vmScaleSetName, parameters).getFinalResult();
    }
    ...
    public void scaleOut(String resourceGroupName, String vmScaleSetName, VMScaleSetScaleOutInput parameters,
        Context context) {
        beginScaleOut(resourceGroupName, vmScaleSetName, parameters, context).getFinalResult();
    }
    ...
    private PagedResponse<VirtualMachineScaleSetInner> listByLocationSinglePage(String location) {
        ...
        final String accept = "application/json";
        Response<VirtualMachineScaleSetListResult> res = service.listByLocationSync(this.client.getEndpoint(),

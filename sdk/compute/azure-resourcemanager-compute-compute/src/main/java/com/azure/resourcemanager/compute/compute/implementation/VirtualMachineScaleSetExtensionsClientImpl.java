...
import com.azure.resourcemanager.compute.compute.models.VirtualMachineScaleSetExtensionListResult;
...
public final class VirtualMachineScaleSetExtensionsClientImpl implements VirtualMachineScaleSetExtensionsClient {
     ...
     */
    VirtualMachineScaleSetExtensionsClientImpl(AzureComputeResourceManagementApiImpl client) {
    ...
    /**
     * The interface defining all the services for AzureComputeResourceManagementApiVirtualMachineScaleSetExtensions to
     * be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "AzureComputeResourceManagementApiVirtualMachineScaleSetExtensions")
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String vmScaleSetName,
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName, vmssExtensionName, extensionParameters,
            accept, Context.NONE);
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String vmScaleSetName,
        ...
        return service.deleteSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName, vmssExtensionName, accept,
            Context.NONE);
    }

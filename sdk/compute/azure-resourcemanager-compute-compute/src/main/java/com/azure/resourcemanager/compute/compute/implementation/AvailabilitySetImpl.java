...
public final class AvailabilitySetImpl implements AvailabilitySet, AvailabilitySet.Definition, AvailabilitySet.Update {
    ...
    AvailabilitySetImpl(String name, com.azure.resourcemanager.compute.compute.ComputeManager serviceManager) {
    ...
    public Response<Void> startMigrationToVirtualMachineScaleSetWithResponse(
        MigrateToVirtualMachineScaleSetInput parameters, Context context) {
        return serviceManager.availabilitySets()
            .startMigrationToVirtualMachineScaleSetWithResponse(resourceGroupName, availabilitySetName, parameters,
                context);
    }

    public void startMigrationToVirtualMachineScaleSet(MigrateToVirtualMachineScaleSetInput parameters) {
        serviceManager.availabilitySets()
            .startMigrationToVirtualMachineScaleSet(resourceGroupName, availabilitySetName, parameters);
    }
    ...
    public void validateMigrationToVirtualMachineScaleSet(MigrateToVirtualMachineScaleSetInput parameters) {
        serviceManager.availabilitySets()
            .validateMigrationToVirtualMachineScaleSet(resourceGroupName, availabilitySetName, parameters);
    }

...
import com.azure.resourcemanager.compute.compute.fluent.VirtualMachineScaleSetVMsClient;
...
import com.azure.resourcemanager.compute.compute.implementation.models.VirtualMachineScaleSetVMListResult;
...
public final class VirtualMachineScaleSetVMsClientImpl implements VirtualMachineScaleSetVMsClient {
    ...
    public interface VirtualMachineScaleSetVMsService {
        ...
        Mono<Response<VirtualMachineScaleSetVMInner>> get(@HostParam("endpoint") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<VirtualMachineScaleSetVMInner> getSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vmScaleSetName") String vmScaleSetName, @PathParam("instanceId") String instanceId,
            @QueryParam("$expand") InstanceViewTypes expand, @HeaderParam("Accept") String accept, Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> update(@HostParam("endpoint") String endpoint,
            ...
            @BodyParam("application/json") VirtualMachineScaleSetVMInner parameters, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<VirtualMachineScaleSetVMListResult>> list(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<VirtualMachineScaleSetVMListResult> listSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("virtualMachineScaleSetName") String virtualMachineScaleSetName,
            @QueryParam("$filter") String filter, @QueryParam("$select") String select,
        ...
        @ExpectedResponses({ 202 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<BinaryData> approveRollingUpgradeSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vmScaleSetName") String vmScaleSetName, @PathParam("instanceId") String instanceId,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<VirtualMachineScaleSetVMInstanceViewInner> getInstanceViewSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vmScaleSetName") String vmScaleSetName, @PathParam("instanceId") String instanceId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<BinaryData> reimageAllSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vmScaleSetName") String vmScaleSetName, @PathParam("instanceId") String instanceId,
            Context context);
        ...
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<Void>> simulateEviction(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vmScaleSetName") String vmScaleSetName, @PathParam("instanceId") String instanceId,
            Context context);
        ...
        @ExpectedResponses({ 204 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<Void> simulateEvictionSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vmScaleSetName") String vmScaleSetName, @PathParam("instanceId") String instanceId,
            Context context);
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<Flux<ByteBuffer>>> attachDetachDataDisks(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vmScaleSetName") String vmScaleSetName, @PathParam("instanceId") String instanceId,
            @HeaderParam("Content-Type") String contentType, @HeaderParam("Accept") String accept,
            @BodyParam("application/json") AttachDetachDataDisksRequest parameters, Context context);

        @Post("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/virtualMachines/{instanceId}/attachDetachDataDisks")
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<BinaryData> attachDetachDataDisksSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vmScaleSetName") String vmScaleSetName, @PathParam("instanceId") String instanceId,
            @HeaderParam("Content-Type") String contentType, @HeaderParam("Accept") String accept,
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<BinaryData> performMaintenanceSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vmScaleSetName") String vmScaleSetName, @PathParam("instanceId") String instanceId,
            Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> powerOff(@HostParam("endpoint") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vmScaleSetName") String vmScaleSetName, @PathParam("instanceId") String instanceId,
            @QueryParam("skipShutdown") Boolean skipShutdown, Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> runCommand(@HostParam("endpoint") String endpoint,
            ...
            @PathParam("vmScaleSetName") String vmScaleSetName, @PathParam("instanceId") String instanceId,
            @HeaderParam("Content-Type") String contentType, @HeaderParam("Accept") String accept,
            @BodyParam("application/json") RunCommandInput parameters, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<VirtualMachineScaleSetVMListResult> listNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("endpoint") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName, String vmScaleSetName,
        ...
        return FluxUtil
            .withContext(context -> service.update(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName, instanceId, ifMatch, ifNoneMatch,
     ...
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return describes a virtual machine scale set virtual machine along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ...
    public SyncPoller<PollResult<VirtualMachineScaleSetVMInner>, VirtualMachineScaleSetVMInner> beginUpdate(
        ...
        Response<BinaryData> response
            = updateWithResponse(resourceGroupName, vmScaleSetName, instanceId, parameters, ifMatch, ifNoneMatch);
        return this.client.<VirtualMachineScaleSetVMInner, VirtualMachineScaleSetVMInner>getLroResult(response,
            VirtualMachineScaleSetVMInner.class, VirtualMachineScaleSetVMInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<VirtualMachineScaleSetVMInner>, VirtualMachineScaleSetVMInner> beginUpdate(
        ...
        Response<BinaryData> response = updateWithResponse(resourceGroupName, vmScaleSetName, instanceId, parameters,
            ifMatch, ifNoneMatch, context);
        return this.client.<VirtualMachineScaleSetVMInner, VirtualMachineScaleSetVMInner>getLroResult(response,
            VirtualMachineScaleSetVMInner.class, VirtualMachineScaleSetVMInner.class, context);
    }
    ...
    public VirtualMachineScaleSetVMInner update(String resourceGroupName, String vmScaleSetName, String instanceId,
        ...
        final String ifMatch = null;
        final String ifNoneMatch = null;
        return beginUpdate(resourceGroupName, vmScaleSetName, instanceId, parameters, ifMatch, ifNoneMatch)
            .getFinalResult();
    }
    ...
    public VirtualMachineScaleSetVMInner update(String resourceGroupName, String vmScaleSetName, String instanceId,
        VirtualMachineScaleSetVMInner parameters, String ifMatch, String ifNoneMatch, Context context) {
        return beginUpdate(resourceGroupName, vmScaleSetName, instanceId, parameters, ifMatch, ifNoneMatch, context)
            .getFinalResult();
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String vmScaleSetName, String instanceId,
        ...
        return service.deleteSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName, instanceId, forceDeletion,
            Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String vmScaleSetName,
        String instanceId, Boolean forceDeletion) {
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, vmScaleSetName, instanceId, forceDeletion);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String vmScaleSetName,
        ...
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, vmScaleSetName, instanceId, forceDeletion, context);
    ...
    public void delete(String resourceGroupName, String vmScaleSetName, String instanceId) {
        final Boolean forceDeletion = null;
        beginDelete(resourceGroupName, vmScaleSetName, instanceId, forceDeletion).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String vmScaleSetName, String instanceId, Boolean forceDeletion,
        Context context) {
        beginDelete(resourceGroupName, vmScaleSetName, instanceId, forceDeletion, context).getFinalResult();
    }
    ...
    private Mono<PagedResponse<VirtualMachineScaleSetVMInner>> listSinglePageAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, virtualMachineScaleSetName, filter, select, expand,
                accept, context))
     ...
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of all virtual machines in a VM scale sets along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<VirtualMachineScaleSetVMInner> listSinglePage(String resourceGroupName,
        String virtualMachineScaleSetName, String filter, String select, String expand) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String accept = "application/json";
        Response<VirtualMachineScaleSetVMListResult> res
            = service.listSync(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
                resourceGroupName, virtualMachineScaleSetName, filter, select, expand, accept, Context.NONE);
    ...
    public PagedIterable<VirtualMachineScaleSetVMInner> list(String resourceGroupName,
        ...
        return new PagedIterable<>(
            () -> listSinglePage(resourceGroupName, virtualMachineScaleSetName, filter, select, expand),
    ...
    public PagedIterable<VirtualMachineScaleSetVMInner> list(String resourceGroupName,
        String virtualMachineScaleSetName, String filter, String select, String expand, Context context) {
        return new PagedIterable<>(
            () -> listSinglePage(resourceGroupName, virtualMachineScaleSetName, filter, select, expand, context),
    ...
    private Mono<Response<Flux<ByteBuffer>>> approveRollingUpgradeWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(
                context -> service.approveRollingUpgrade(this.client.getEndpoint(), this.client.getApiVersion(),
    ...
    private Response<BinaryData> approveRollingUpgradeWithResponse(String resourceGroupName, String vmScaleSetName,
        ...
        return service.approveRollingUpgradeSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName, instanceId, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginApproveRollingUpgrade(String resourceGroupName,
        String vmScaleSetName, String instanceId) {
        Response<BinaryData> response
            = approveRollingUpgradeWithResponse(resourceGroupName, vmScaleSetName, instanceId);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginApproveRollingUpgrade(String resourceGroupName,
        ...
        Response<BinaryData> response
            = approveRollingUpgradeWithResponse(resourceGroupName, vmScaleSetName, instanceId, context);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, context);
    }
    ...
    public void approveRollingUpgrade(String resourceGroupName, String vmScaleSetName, String instanceId) {
        beginApproveRollingUpgrade(resourceGroupName, vmScaleSetName, instanceId).getFinalResult();
    }
    ...
    public void approveRollingUpgrade(String resourceGroupName, String vmScaleSetName, String instanceId,
        Context context) {
        beginApproveRollingUpgrade(resourceGroupName, vmScaleSetName, instanceId, context).getFinalResult();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDeallocate(String resourceGroupName, String vmScaleSetName,
        String instanceId) {
        Response<BinaryData> response = deallocateWithResponse(resourceGroupName, vmScaleSetName, instanceId);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDeallocate(String resourceGroupName, String vmScaleSetName,
        String instanceId, Context context) {
        Response<BinaryData> response = deallocateWithResponse(resourceGroupName, vmScaleSetName, instanceId, context);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, context);
    }
    ...
    public void deallocate(String resourceGroupName, String vmScaleSetName, String instanceId) {
        beginDeallocate(resourceGroupName, vmScaleSetName, instanceId).getFinalResult();
    }
    ...
    public void deallocate(String resourceGroupName, String vmScaleSetName, String instanceId, Context context) {
        beginDeallocate(resourceGroupName, vmScaleSetName, instanceId, context).getFinalResult();
    }
    ...
    private Mono<Response<VirtualMachineScaleSetVMInstanceViewInner>>
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.getInstanceView(this.client.getEndpoint(), this.client.getApiVersion(),
    ...
    public Response<VirtualMachineScaleSetVMInstanceViewInner> getInstanceViewWithResponse(String resourceGroupName,
        ...
        final String accept = "application/json";
        return service.getInstanceViewSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName, instanceId, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> reimageWithResponse(String resourceGroupName, String vmScaleSetName, String instanceId,
        ...
        return service.reimageSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName, instanceId, vmScaleSetVMReimageInput,
            Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginReimage(String resourceGroupName, String vmScaleSetName,
        String instanceId, VirtualMachineScaleSetVMReimageParameters vmScaleSetVMReimageInput) {
        Response<BinaryData> response
            = reimageWithResponse(resourceGroupName, vmScaleSetName, instanceId, vmScaleSetVMReimageInput);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginReimage(String resourceGroupName, String vmScaleSetName,
        ...
        Response<BinaryData> response
            = reimageWithResponse(resourceGroupName, vmScaleSetName, instanceId, vmScaleSetVMReimageInput, context);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, context);
    }
    ...
    public void reimage(String resourceGroupName, String vmScaleSetName, String instanceId) {
        final VirtualMachineScaleSetVMReimageParameters vmScaleSetVMReimageInput = null;
        beginReimage(resourceGroupName, vmScaleSetName, instanceId, vmScaleSetVMReimageInput).getFinalResult();
    }
    ...
    public void reimage(String resourceGroupName, String vmScaleSetName, String instanceId,
        VirtualMachineScaleSetVMReimageParameters vmScaleSetVMReimageInput, Context context) {
        beginReimage(resourceGroupName, vmScaleSetName, instanceId, vmScaleSetVMReimageInput, context).getFinalResult();
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> reimageAllWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.reimageAll(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName, instanceId, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Response<BinaryData> reimageAllWithResponse(String resourceGroupName, String vmScaleSetName,
        ...
        return service.reimageAllSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName, instanceId, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginReimageAll(String resourceGroupName, String vmScaleSetName,
        String instanceId) {
        Response<BinaryData> response = reimageAllWithResponse(resourceGroupName, vmScaleSetName, instanceId);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginReimageAll(String resourceGroupName, String vmScaleSetName,
        String instanceId, Context context) {
        Response<BinaryData> response = reimageAllWithResponse(resourceGroupName, vmScaleSetName, instanceId, context);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, context);
    }
    ...
    public void reimageAll(String resourceGroupName, String vmScaleSetName, String instanceId) {
        beginReimageAll(resourceGroupName, vmScaleSetName, instanceId).getFinalResult();
    }
    ...
    public void reimageAll(String resourceGroupName, String vmScaleSetName, String instanceId, Context context) {
        beginReimageAll(resourceGroupName, vmScaleSetName, instanceId, context).getFinalResult();
    }
    ...
    private Mono<Response<Void>> simulateEvictionWithResponseAsync(String resourceGroupName, String vmScaleSetName,
        ...
        return FluxUtil
            .withContext(context -> service.simulateEviction(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName, instanceId, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    public Response<Void> simulateEvictionWithResponse(String resourceGroupName, String vmScaleSetName,
        ...
        return service.simulateEvictionSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName, instanceId, context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> attachDetachDataDisksWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.attachDetachDataDisks(this.client.getEndpoint(),
                this.client.getApiVersion(), this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName,
                instanceId, contentType, accept, parameters, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> attachDetachDataDisksWithResponse(String resourceGroupName, String vmScaleSetName,
        ...
        final String contentType = "application/json";
        final String accept = "application/json";
        return service.attachDetachDataDisksSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName, instanceId, contentType, accept,
    ...
    public SyncPoller<PollResult<StorageProfileInner>, StorageProfileInner> beginAttachDetachDataDisks(
        String resourceGroupName, String vmScaleSetName, String instanceId, AttachDetachDataDisksRequest parameters) {
        Response<BinaryData> response
            = attachDetachDataDisksWithResponse(resourceGroupName, vmScaleSetName, instanceId, parameters);
    ...
    public SyncPoller<PollResult<StorageProfileInner>, StorageProfileInner> beginAttachDetachDataDisks(
        ...
        Context context) {
        Response<BinaryData> response
            = attachDetachDataDisksWithResponse(resourceGroupName, vmScaleSetName, instanceId, parameters, context);
        return this.client.<StorageProfileInner, StorageProfileInner>getLroResult(response, StorageProfileInner.class,
    ...
    public StorageProfileInner attachDetachDataDisks(String resourceGroupName, String vmScaleSetName, String instanceId,
        ...
        return beginAttachDetachDataDisks(resourceGroupName, vmScaleSetName, instanceId, parameters).getFinalResult();
    }
    ...
    public StorageProfileInner attachDetachDataDisks(String resourceGroupName, String vmScaleSetName, String instanceId,
        ...
        return beginAttachDetachDataDisks(resourceGroupName, vmScaleSetName, instanceId, parameters, context)
            .getFinalResult();
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> performMaintenanceWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.performMaintenance(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName, instanceId, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Response<BinaryData> performMaintenanceWithResponse(String resourceGroupName, String vmScaleSetName,
        ...
        return service.performMaintenanceSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName, instanceId, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginPerformMaintenance(String resourceGroupName, String vmScaleSetName,
        String instanceId) {
        Response<BinaryData> response = performMaintenanceWithResponse(resourceGroupName, vmScaleSetName, instanceId);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginPerformMaintenance(String resourceGroupName, String vmScaleSetName,
        String instanceId, Context context) {
        Response<BinaryData> response
            = performMaintenanceWithResponse(resourceGroupName, vmScaleSetName, instanceId, context);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, context);
    }
    ...
    public void performMaintenance(String resourceGroupName, String vmScaleSetName, String instanceId) {
        beginPerformMaintenance(resourceGroupName, vmScaleSetName, instanceId).getFinalResult();
    }
    ...
    public void performMaintenance(String resourceGroupName, String vmScaleSetName, String instanceId,
        Context context) {
        beginPerformMaintenance(resourceGroupName, vmScaleSetName, instanceId, context).getFinalResult();
    }
    ...
    private Response<BinaryData> powerOffWithResponse(String resourceGroupName, String vmScaleSetName,
        ...
        return service.powerOffSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName, instanceId, skipShutdown, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginPowerOff(String resourceGroupName, String vmScaleSetName,
        String instanceId, Boolean skipShutdown) {
        Response<BinaryData> response
            = powerOffWithResponse(resourceGroupName, vmScaleSetName, instanceId, skipShutdown);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginPowerOff(String resourceGroupName, String vmScaleSetName,
        String instanceId, Boolean skipShutdown, Context context) {
        Response<BinaryData> response
            = powerOffWithResponse(resourceGroupName, vmScaleSetName, instanceId, skipShutdown, context);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, context);
    }
    ...
    public void powerOff(String resourceGroupName, String vmScaleSetName, String instanceId) {
        final Boolean skipShutdown = null;
        beginPowerOff(resourceGroupName, vmScaleSetName, instanceId, skipShutdown).getFinalResult();
    }
    ...
    public void powerOff(String resourceGroupName, String vmScaleSetName, String instanceId, Boolean skipShutdown,
        Context context) {
        beginPowerOff(resourceGroupName, vmScaleSetName, instanceId, skipShutdown, context).getFinalResult();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginRedeploy(String resourceGroupName, String vmScaleSetName,
        String instanceId) {
        Response<BinaryData> response = redeployWithResponse(resourceGroupName, vmScaleSetName, instanceId);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginRedeploy(String resourceGroupName, String vmScaleSetName,
        String instanceId, Context context) {
        Response<BinaryData> response = redeployWithResponse(resourceGroupName, vmScaleSetName, instanceId, context);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, context);
    }
    ...
    public void redeploy(String resourceGroupName, String vmScaleSetName, String instanceId) {
        beginRedeploy(resourceGroupName, vmScaleSetName, instanceId).getFinalResult();
    }
    ...
    public void redeploy(String resourceGroupName, String vmScaleSetName, String instanceId, Context context) {
        beginRedeploy(resourceGroupName, vmScaleSetName, instanceId, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> restartWithResponse(String resourceGroupName, String vmScaleSetName, String instanceId,
        Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
    ...
    public SyncPoller<PollResult<Void>, Void> beginRestart(String resourceGroupName, String vmScaleSetName,
        String instanceId) {
        Response<BinaryData> response = restartWithResponse(resourceGroupName, vmScaleSetName, instanceId);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginRestart(String resourceGroupName, String vmScaleSetName,
        String instanceId, Context context) {
        Response<BinaryData> response = restartWithResponse(resourceGroupName, vmScaleSetName, instanceId, context);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, context);
    }
    ...
    public void restart(String resourceGroupName, String vmScaleSetName, String instanceId) {
        beginRestart(resourceGroupName, vmScaleSetName, instanceId).getFinalResult();
    }
    ...
    public void restart(String resourceGroupName, String vmScaleSetName, String instanceId, Context context) {
        beginRestart(resourceGroupName, vmScaleSetName, instanceId, context).getFinalResult();
    }
    ...
    private Mono<Response<RetrieveBootDiagnosticsDataResultInner>> retrieveBootDiagnosticsDataWithResponseAsync(
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.retrieveBootDiagnosticsData(this.client.getEndpoint(),
                this.client.getApiVersion(), this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName,
                instanceId, sasUriExpirationTimeInMinutes, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    public Response<RetrieveBootDiagnosticsDataResultInner> retrieveBootDiagnosticsDataWithResponse(
        ...
        final String accept = "application/json";
        return service.retrieveBootDiagnosticsDataSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName, instanceId,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> startWithResponse(String resourceGroupName, String vmScaleSetName, String instanceId) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
    ...
    public SyncPoller<PollResult<Void>, Void> beginStart(String resourceGroupName, String vmScaleSetName,
        String instanceId) {
        Response<BinaryData> response = startWithResponse(resourceGroupName, vmScaleSetName, instanceId);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginStart(String resourceGroupName, String vmScaleSetName,
        String instanceId, Context context) {
        Response<BinaryData> response = startWithResponse(resourceGroupName, vmScaleSetName, instanceId, context);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, context);
    }
    ...
    public void start(String resourceGroupName, String vmScaleSetName, String instanceId) {
        beginStart(resourceGroupName, vmScaleSetName, instanceId).getFinalResult();
    }
    ...
    public void start(String resourceGroupName, String vmScaleSetName, String instanceId, Context context) {
        beginStart(resourceGroupName, vmScaleSetName, instanceId, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> runCommandWithResponse(String resourceGroupName, String vmScaleSetName,
    ...
    public SyncPoller<PollResult<RunCommandResultInner>, RunCommandResultInner> beginRunCommand(
        String resourceGroupName, String vmScaleSetName, String instanceId, RunCommandInput parameters) {
        Response<BinaryData> response
            = runCommandWithResponse(resourceGroupName, vmScaleSetName, instanceId, parameters);
    ...
    public SyncPoller<PollResult<RunCommandResultInner>, RunCommandResultInner> beginRunCommand(
        ...
        Context context) {
        Response<BinaryData> response
            = runCommandWithResponse(resourceGroupName, vmScaleSetName, instanceId, parameters, context);
        return this.client.<RunCommandResultInner, RunCommandResultInner>getLroResult(response,
    ...
    public RunCommandResultInner runCommand(String resourceGroupName, String vmScaleSetName, String instanceId,
        ...
        return beginRunCommand(resourceGroupName, vmScaleSetName, instanceId, parameters).getFinalResult();
    }
    ...
    public RunCommandResultInner runCommand(String resourceGroupName, String vmScaleSetName, String instanceId,
        ...
        return beginRunCommand(resourceGroupName, vmScaleSetName, instanceId, parameters, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<VirtualMachineScaleSetVMInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<VirtualMachineScaleSetVMInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(VirtualMachineScaleSetVMsClientImpl.class);
}

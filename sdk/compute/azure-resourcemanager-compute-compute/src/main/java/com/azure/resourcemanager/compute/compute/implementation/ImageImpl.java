...
public final class ImageImpl implements Image, Image.Definition, Image.Update {
    ...
    ImageImpl(String name, com.azure.resourcemanager.compute.compute.ComputeManager serviceManager) {
    ...
    ImageImpl(ImageInner innerObject, com.azure.resourcemanager.compute.compute.ComputeManager serviceManager) {

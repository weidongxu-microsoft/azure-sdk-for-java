...
public final class VirtualMachineScaleSetRollingUpgradesClientImpl
    ...
    public interface VirtualMachineScaleSetRollingUpgradesService {
        ...
        Mono<Response<Flux<ByteBuffer>>> startExtensionUpgrade(@HostParam("endpoint") String endpoint,
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<BinaryData> startExtensionUpgradeSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vmScaleSetName") String vmScaleSetName, Context context);
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<Flux<ByteBuffer>>> startOSUpgrade(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vmScaleSetName") String vmScaleSetName, Context context);
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<BinaryData> startOSUpgradeSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vmScaleSetName") String vmScaleSetName, Context context);
        ...
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<RollingUpgradeStatusInfoInner>> getLatest(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<RollingUpgradeStatusInfoInner> getLatestSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vmScaleSetName") String vmScaleSetName, @HeaderParam("Accept") String accept, Context context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> startExtensionUpgradeWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(
                context -> service.startExtensionUpgrade(this.client.getEndpoint(), this.client.getApiVersion(),
    ...
    private Response<BinaryData> startExtensionUpgradeWithResponse(String resourceGroupName, String vmScaleSetName) {
        ...
        return service.startExtensionUpgradeSync(this.client.getEndpoint(), this.client.getApiVersion(),
    ...
    private Mono<Response<Flux<ByteBuffer>>> startOSUpgradeWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.startOSUpgrade(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Response<BinaryData> startOSUpgradeWithResponse(String resourceGroupName, String vmScaleSetName) {
        ...
        return service.startOSUpgradeSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName, Context.NONE);
    }
    ...
    private Mono<Response<RollingUpgradeStatusInfoInner>> getLatestWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.getLatest(this.client.getEndpoint(), this.client.getApiVersion(),
    ...
    public Response<RollingUpgradeStatusInfoInner> getLatestWithResponse(String resourceGroupName,
        ...
        final String accept = "application/json";
        return service.getLatestSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, vmScaleSetName, accept, context);
    }

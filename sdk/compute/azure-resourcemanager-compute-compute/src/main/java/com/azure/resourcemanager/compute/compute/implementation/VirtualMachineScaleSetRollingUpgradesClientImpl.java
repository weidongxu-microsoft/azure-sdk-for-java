...
public final class VirtualMachineScaleSetRollingUpgradesClientImpl
     ...
     */
    VirtualMachineScaleSetRollingUpgradesClientImpl(AzureComputeResourceManagementApiImpl client) {
     ...
     * AzureComputeResourceManagementApiVirtualMachineScaleSetRollingUpgrades to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "AzureComputeResourceManagementApiVirtualMachineScaleSetRollingUpgrades")

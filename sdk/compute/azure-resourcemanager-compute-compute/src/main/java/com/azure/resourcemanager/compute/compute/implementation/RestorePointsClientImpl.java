...
import com.azure.resourcemanager.compute.compute.fluent.models.RestorePointInner;
import com.azure.resourcemanager.compute.compute.models.ApiErrorException;
import com.azure.resourcemanager.compute.compute.models.RestorePointExpandOptions;
...
public final class RestorePointsClientImpl implements RestorePointsClient {
     ...
     */
    RestorePointsClientImpl(AzureComputeResourceManagementApiImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AzureComputeResourceManagementApiRestorePoints to be used by the
     * proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "AzureComputeResourceManagementApiRestorePoints")
    public interface RestorePointsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<RestorePointInner> getSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("restorePointCollectionName") String restorePointCollectionName,
            @PathParam("restorePointName") String restorePointName,
    ...
    public Response<RestorePointInner> getWithResponse(String resourceGroupName, String restorePointCollectionName,
        ...
        if (restorePointName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter restorePointName is required and cannot be null."));
        }
        final String accept = "application/json";
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> createWithResponse(String resourceGroupName, String restorePointCollectionName,
    ...
    public SyncPoller<PollResult<RestorePointInner>, RestorePointInner> beginCreate(String resourceGroupName,
        ...
        Response<BinaryData> response
            = createWithResponse(resourceGroupName, restorePointCollectionName, restorePointName, parameters);
        return this.client.<RestorePointInner, RestorePointInner>getLroResult(response, RestorePointInner.class,
            RestorePointInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<RestorePointInner>, RestorePointInner> beginCreate(String resourceGroupName,
        ...
        Response<BinaryData> response
            = createWithResponse(resourceGroupName, restorePointCollectionName, restorePointName, parameters, context);
        return this.client.<RestorePointInner, RestorePointInner>getLroResult(response, RestorePointInner.class,
            RestorePointInner.class, context);
    }
    ...
    public RestorePointInner create(String resourceGroupName, String restorePointCollectionName,
        String restorePointName, RestorePointInner parameters) {
        return beginCreate(resourceGroupName, restorePointCollectionName, restorePointName, parameters)
            .getFinalResult();
    }
    ...
    public RestorePointInner create(String resourceGroupName, String restorePointCollectionName,
        String restorePointName, RestorePointInner parameters, Context context) {
        return beginCreate(resourceGroupName, restorePointCollectionName, restorePointName, parameters, context)
            .getFinalResult();
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String restorePointCollectionName,
        ...
        return service.deleteSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, restorePointCollectionName, restorePointName, accept,
            Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String restorePointCollectionName,
        String restorePointName) {
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, restorePointCollectionName, restorePointName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String restorePointCollectionName,
        String restorePointName, Context context) {
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, restorePointCollectionName, restorePointName, context);
    ...
    public void delete(String resourceGroupName, String restorePointCollectionName, String restorePointName) {
        beginDelete(resourceGroupName, restorePointCollectionName, restorePointName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String restorePointCollectionName, String restorePointName,
        Context context) {
        beginDelete(resourceGroupName, restorePointCollectionName, restorePointName, context).getFinalResult();
    }

    private static final ClientLogger LOGGER = new ClientLogger(RestorePointsClientImpl.class);
}

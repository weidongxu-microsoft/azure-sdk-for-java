...
import com.azure.resourcemanager.compute.compute.models.ProximityPlacementGroupListResult;
...
public final class ProximityPlacementGroupsClientImpl implements ProximityPlacementGroupsClient {
     ...
     */
    ProximityPlacementGroupsClientImpl(AzureComputeResourceManagementApiImpl client) {
    ...
    /**
     * The interface defining all the services for AzureComputeResourceManagementApiProximityPlacementGroups to be used
     * by the proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "AzureComputeResourceManagementApiProximityPlacementGroups")

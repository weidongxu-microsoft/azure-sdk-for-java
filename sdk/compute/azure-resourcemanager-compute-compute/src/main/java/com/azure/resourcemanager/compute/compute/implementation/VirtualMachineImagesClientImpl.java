...
import com.azure.resourcemanager.compute.compute.fluent.VirtualMachineImagesClient;
...
public final class VirtualMachineImagesClientImpl implements VirtualMachineImagesClient {
    ...
    public interface VirtualMachineImagesService {
        ...
        Mono<Response<VmImagesInEdgeZoneListResultInner>> listByEdgeZone(@HostParam("endpoint") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<VmImagesInEdgeZoneListResultInner> listByEdgeZoneSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("location") String location, @PathParam("edgeZone") String edgeZone,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<List<VirtualMachineImageResourceInner>>> listPublishers(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<List<VirtualMachineImageResourceInner>> listPublishersSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("location") String location, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<List<VirtualMachineImageResourceInner>>> listOffers(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<List<VirtualMachineImageResourceInner>> listOffersSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("location") String location, @PathParam("publisherName") String publisherName,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<List<VirtualMachineImageResourceInner>>> listSkus(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("location") String location, @PathParam("publisherName") String publisherName,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<List<VirtualMachineImageResourceInner>> listSkusSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("location") String location, @PathParam("publisherName") String publisherName,
            @PathParam("offer") String offer, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<List<VirtualMachineImageResourceInner>>> list(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("location") String location, @PathParam("publisherName") String publisherName,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<List<VirtualMachineImageResourceInner>> listSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("location") String location, @PathParam("publisherName") String publisherName,
            @PathParam("offer") String offer, @PathParam("skus") String skus, @QueryParam("$expand") String expand,
            @QueryParam("$top") Integer top, @QueryParam("$orderby") String orderby,
        ...
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/providers/Microsoft.Compute/locations/{location}/publishers/{publisherName}/artifacttypes/vmimage/offers/{offer}/skus/{skus}/versions?$expand=Properties")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<List<VirtualMachineImageInner>>> listWithProperties(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("location") String location, @PathParam("publisherName") String publisherName,
            @PathParam("offer") String offer, @PathParam("skus") String skus, @QueryParam("$expand") String expand,
            @QueryParam("$top") Integer top, @QueryParam("$orderby") String orderby,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<List<VirtualMachineImageInner>> listWithPropertiesSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("location") String location, @PathParam("publisherName") String publisherName,
            @PathParam("offer") String offer, @PathParam("skus") String skus, @QueryParam("$expand") String expand,
            @QueryParam("$top") Integer top, @QueryParam("$orderby") String orderby,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<VirtualMachineImageInner>> get(@HostParam("endpoint") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<VirtualMachineImageInner> getSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("location") String location,
            @PathParam("publisherName") String publisherName, @PathParam("offer") String offer,
            @PathParam("skus") String skus, @PathParam("version") String version,
            @PathParam("subscriptionId") String subscriptionId, @HeaderParam("Accept") String accept, Context context);
    ...
    private Mono<Response<VmImagesInEdgeZoneListResultInner>> listByEdgeZoneWithResponseAsync(String location,
        ...
        return FluxUtil
            .withContext(context -> service.listByEdgeZone(this.client.getEndpoint(), this.client.getApiVersion(),
    ...
    public Response<VmImagesInEdgeZoneListResultInner> listByEdgeZoneWithResponse(String location, String edgeZone,
        ...
        if (edgeZone == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter edgeZone is required and cannot be null."));
        }
        final String accept = "application/json";
        return service.listByEdgeZoneSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), location, edgeZone, accept, context);
    }
    ...
    private Mono<Response<List<VirtualMachineImageResourceInner>>> listPublishersWithResponseAsync(String location) {
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listPublishers(this.client.getEndpoint(), this.client.getApiVersion(),
    ...
    public Response<List<VirtualMachineImageResourceInner>> listPublishersWithResponse(String location,
        ...
        final String accept = "application/json";
        return service.listPublishersSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), location, accept, context);
    }
    ...
    private Mono<Response<List<VirtualMachineImageResourceInner>>> listOffersWithResponseAsync(String location,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listOffers(this.client.getEndpoint(), this.client.getApiVersion(),
    ...
    public Response<List<VirtualMachineImageResourceInner>> listOffersWithResponse(String location,
        ...
        if (publisherName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter publisherName is required and cannot be null."));
        }
        final String accept = "application/json";
        return service.listOffersSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), location, publisherName, accept, context);
    }
    ...
    public Response<List<VirtualMachineImageResourceInner>> listSkusWithResponse(String location, String publisherName,
        ...
        if (offer == null) {
            throw LOGGER.atError().log(new IllegalArgumentException("Parameter offer is required and cannot be null."));
        }
        final String accept = "application/json";
    ...
    public Response<List<VirtualMachineImageResourceInner>> listWithResponse(String location, String publisherName,
        ...
        if (skus == null) {
            throw LOGGER.atError().log(new IllegalArgumentException("Parameter skus is required and cannot be null."));
        }
        final String accept = "application/json";
    ...
    private Mono<Response<List<VirtualMachineImageInner>>> listWithPropertiesWithResponseAsync(String location,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listWithProperties(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), location, publisherName, offer, skus, expand, top, orderby, accept,
                context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<List<VirtualMachineImageInner>> listWithPropertiesAsync(String location, String publisherName,
        String offer, String skus, String expand) {
        final Integer top = null;
        final String orderby = null;
        return listWithPropertiesWithResponseAsync(location, publisherName, offer, skus, expand, top, orderby)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<List<VirtualMachineImageInner>> listWithPropertiesWithResponse(String location,
        ...
        if (expand == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter expand is required and cannot be null."));
        }
        final String accept = "application/json";
        return service.listWithPropertiesSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), location, publisherName, offer, skus, expand, top, orderby, accept,
            context);
    }
    ...
    public List<VirtualMachineImageInner> listWithProperties(String location, String publisherName, String offer,
        ...
        final Integer top = null;
        final String orderby = null;
        return listWithPropertiesWithResponse(location, publisherName, offer, skus, expand, top, orderby, Context.NONE)
            .getValue();
    }
    ...
    public Response<VirtualMachineImageInner> getWithResponse(String location, String publisherName, String offer,
        ...
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), this.client.getApiVersion(), location, publisherName, offer,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(VirtualMachineImagesClientImpl.class);
}

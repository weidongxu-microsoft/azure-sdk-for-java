...
import com.azure.resourcemanager.compute.compute.models.RecoveryWalkResponse;
import com.azure.resourcemanager.compute.compute.models.UpgradeOperationHistoricalStatusInfo;
...
import com.azure.resourcemanager.compute.compute.models.VirtualMachineScaleSetInstanceView;
...
public final class VirtualMachineScaleSetsImpl implements VirtualMachineScaleSets {
    ...
    public void scaleOut(String resourceGroupName, String vmScaleSetName, VMScaleSetScaleOutInput parameters) {
        this.serviceClient().scaleOut(resourceGroupName, vmScaleSetName, parameters);
    }

    public void scaleOut(String resourceGroupName, String vmScaleSetName, VMScaleSetScaleOutInput parameters,
        Context context) {
        this.serviceClient().scaleOut(resourceGroupName, vmScaleSetName, parameters, context);
    }

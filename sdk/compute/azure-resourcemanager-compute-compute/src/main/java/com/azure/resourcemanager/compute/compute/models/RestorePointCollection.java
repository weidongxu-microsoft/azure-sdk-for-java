...
public interface RestorePointCollection {
    ...
    /**
     * Gets the instantAccess property: This property determines whether instant access snapshot is enabled for restore
    ...
    /**
     * Gets the inner com.azure.resourcemanager.compute.compute.fluent.models.RestorePointCollectionInner object.
     * 
    ...
    interface DefinitionStages {
        ...
        interface WithCreate
            extends DefinitionStages.WithTags, DefinitionStages.WithSource, DefinitionStages.WithInstantAccess {
            /**
        ...
        /**
         * The stage of the RestorePointCollection definition allowing to specify instantAccess.
         */
        interface WithInstantAccess {
            /**
             * Specifies the instantAccess property: This property determines whether instant access snapshot is enabled
             * for restore points created under this restore point collection for Premium SSD v2 or Ultra disk. Instant
             * access snapshot for Premium SSD v2 or Ultra disk is instantaneously available for restoring disk with
             * fast restore performance..
             * 
             * @param instantAccess This property determines whether instant access snapshot is enabled for restore
             * points created under this restore point collection for Premium SSD v2 or Ultra disk. Instant access
             * snapshot for Premium SSD v2 or Ultra disk is instantaneously available for restoring disk with fast
             * restore performance.
             * @return the next definition stage.
             */
            WithCreate withInstantAccess(Boolean instantAccess);
        }
    }
     ...
     */
    interface Update extends UpdateStages.WithTags, UpdateStages.WithSource, UpdateStages.WithInstantAccess {
        /**
    ...
    interface UpdateStages {
        ...
        /**
         * The stage of the RestorePointCollection update allowing to specify instantAccess.
         */
        interface WithInstantAccess {
            /**
             * Specifies the instantAccess property: This property determines whether instant access snapshot is enabled
             ...
             * @return the next definition stage.
             */
            Update withInstantAccess(Boolean instantAccess);
        }
    }

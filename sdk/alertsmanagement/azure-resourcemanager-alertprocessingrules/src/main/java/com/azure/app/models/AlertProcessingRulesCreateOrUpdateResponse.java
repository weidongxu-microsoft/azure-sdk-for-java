...
public final class AlertProcessingRulesCreateOrUpdateResponse
     ...
     */
    public AlertProcessingRulesCreateOrUpdateResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders,
        AlertProcessingRuleInner value, AlertProcessingRulesCreateOrUpdateHeaders headers) {

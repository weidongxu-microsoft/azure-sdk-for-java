...
import com.azure.app.fluent.AlertProcessingRulesClient;
import com.azure.app.fluent.models.AlertProcessingRuleInner;
import com.azure.app.models.AlertProcessingRulesCreateOrUpdateResponse;
import com.azure.app.models.AlertProcessingRulesDeleteResponse;
import com.azure.app.models.AlertProcessingRulesGetByResourceGroupResponse;
import com.azure.app.models.AlertProcessingRulesList;
import com.azure.app.models.AlertProcessingRulesUpdateResponse;
import com.azure.app.models.PatchObject;
...
public final class AlertProcessingRulesClientImpl implements AlertProcessingRulesClient {
     ...
     */
    AlertProcessingRulesClientImpl(AzureAlertsManagementServiceResourceProviderImpl client) {
    ...
    /**
     * The interface defining all the services for AzureAlertsManagementServiceResourceProviderAlertProcessingRules to
     * be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "AzureAlertsManagementServiceResourceProviderAlertProcessingRules")
    ...
    public AlertProcessingRulesCreateOrUpdateResponse createOrUpdateWithResponse(String resourceGroupName,
        ...
        if (alertProcessingRule == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter alertProcessingRule is required and cannot be null."));
        } else {
            alertProcessingRule.validate();
        }
        final String accept = "application/json";
    ...
    private static final ClientLogger LOGGER = new ClientLogger(AlertProcessingRulesClientImpl.class);
}

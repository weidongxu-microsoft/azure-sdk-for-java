...
public final class AlertProcessingRuleImpl
    ...
    AlertProcessingRuleImpl(String name, com.azure.app.AppManager serviceManager) {
    ...
    AlertProcessingRuleImpl(AlertProcessingRuleInner innerObject, com.azure.app.AppManager serviceManager) {

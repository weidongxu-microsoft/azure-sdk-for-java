...
public final class CosmosPartitionKeyTests extends TestSuiteBase {
    ...
    private void createContainerWithoutPk() throws URISyntaxException, IOException {
        ...
        String authorization = base.generateKeyAuthorizationSignature(HttpConstants.HttpMethod.POST, resourceId, Paths.COLLECTIONS_PATH_SEGMENT, headers);
        ...
        authorization = base.generateKeyAuthorizationSignature(HttpConstants.HttpMethod.POST, resourceId, Paths.DOCUMENTS_PATH_SEGMENT, headers);
        headers.put(HttpConstants.HttpHeaders.AUTHORIZATION, URLEncoder.encode(authorization, "UTF-8"));
